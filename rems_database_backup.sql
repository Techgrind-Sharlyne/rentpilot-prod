...
DROP POLICY IF EXISTS users_view_tenants ON public.users;
DROP POLICY IF EXISTS users_own_data ON public.users;
DROP POLICY IF EXISTS payments_tenant_access ON public.payments;
DROP POLICY IF EXISTS payments_landlord_access ON public.payments;
DROP POLICY IF EXISTS maintenance_tenant_access ON public.maintenance_requests;
DROP POLICY IF EXISTS maintenance_staff_access ON public.maintenance_requests;
DROP POLICY IF EXISTS leases_tenant_access ON public.leases;
DROP POLICY IF EXISTS leases_management_access ON public.leases;
DROP POLICY IF EXISTS documents_owner_access ON public.tenant_documents;
ALTER TABLE IF EXISTS ONLY public.users DROP CONSTRAINT IF EXISTS users_deleted_by_fkey;
ALTER TABLE IF EXISTS ONLY public.users DROP CONSTRAINT IF EXISTS users_approved_by_fkey;
ALTER TABLE IF EXISTS ONLY public.user_access_requests DROP CONSTRAINT IF EXISTS user_access_requests_reviewed_by_fkey;
ALTER TABLE IF EXISTS ONLY public.units DROP CONSTRAINT IF EXISTS units_property_id_properties_id_fk;
ALTER TABLE IF EXISTS ONLY public.units DROP CONSTRAINT IF EXISTS units_deleted_by_fkey;
ALTER TABLE IF EXISTS ONLY public.unit_recurring_fees DROP CONSTRAINT IF EXISTS unit_recurring_fees_unit_id_fkey;
ALTER TABLE IF EXISTS ONLY public.tenant_gadgets DROP CONSTRAINT IF EXISTS tenant_gadgets_tenant_id_fkey;
ALTER TABLE IF EXISTS ONLY public.tenant_gadgets DROP CONSTRAINT IF EXISTS tenant_gadgets_lease_id_fkey;
ALTER TABLE IF EXISTS ONLY public.tenant_documents DROP CONSTRAINT IF EXISTS tenant_documents_uploaded_by_fkey;
ALTER TABLE IF EXISTS ONLY public.tenant_documents DROP CONSTRAINT IF EXISTS tenant_documents_tenant_id_fkey;
ALTER TABLE IF EXISTS ONLY public.tenant_deposits DROP CONSTRAINT IF EXISTS tenant_deposits_tenant_id_fkey;
ALTER TABLE IF EXISTS ONLY public.tenant_deposits DROP CONSTRAINT IF EXISTS tenant_deposits_lease_id_fkey;
ALTER TABLE IF EXISTS ONLY public.property_recurring_fees DROP CONSTRAINT IF EXISTS property_recurring_fees_property_id_fkey;
ALTER TABLE IF EXISTS ONLY public.properties DROP CONSTRAINT IF EXISTS properties_owner_id_users_id_fk;
ALTER TABLE IF EXISTS ONLY public.properties DROP CONSTRAINT IF EXISTS properties_manager_id_users_id_fk;
ALTER TABLE IF EXISTS ONLY public.properties DROP CONSTRAINT IF EXISTS properties_deleted_by_fkey;
ALTER TABLE IF EXISTS ONLY public.payments DROP CONSTRAINT IF EXISTS payments_unit_id_units_id_fk;
ALTER TABLE IF EXISTS ONLY public.payments DROP CONSTRAINT IF EXISTS payments_tenant_id_users_id_fk;
ALTER TABLE IF EXISTS ONLY public.payments DROP CONSTRAINT IF EXISTS payments_lease_id_leases_id_fk;
ALTER TABLE IF EXISTS ONLY public.payments DROP CONSTRAINT IF EXISTS payments_invoice_id_fkey;
ALTER TABLE IF EXISTS ONLY public.maintenance_requests DROP CONSTRAINT IF EXISTS maintenance_requests_unit_id_units_id_fk;
ALTER TABLE IF EXISTS ONLY public.maintenance_requests DROP CONSTRAINT IF EXISTS maintenance_requests_tenant_id_users_id_fk;
ALTER TABLE IF EXISTS ONLY public.maintenance_requests DROP CONSTRAINT IF EXISTS maintenance_requests_assigned_to_users_id_fk;
ALTER TABLE IF EXISTS ONLY public.leases DROP CONSTRAINT IF EXISTS leases_unit_id_units_id_fk;
ALTER TABLE IF EXISTS ONLY public.leases DROP CONSTRAINT IF EXISTS leases_tenant_id_users_id_fk;
ALTER TABLE IF EXISTS ONLY public.leases DROP CONSTRAINT IF EXISTS leases_deleted_by_fkey;
ALTER TABLE IF EXISTS ONLY public.invoices DROP CONSTRAINT IF EXISTS invoices_unit_id_units_id_fk;
ALTER TABLE IF EXISTS ONLY public.invoices DROP CONSTRAINT IF EXISTS invoices_tenant_id_users_id_fk;
ALTER TABLE IF EXISTS ONLY public.expenditures DROP CONSTRAINT IF EXISTS expenditures_property_id_fkey;
ALTER TABLE IF EXISTS ONLY public.expenditures DROP CONSTRAINT IF EXISTS expenditures_deleted_by_fkey;
...
DROP TRIGGER IF EXISTS tenant_documents_audit_trigger ON public.tenant_documents;
DROP TRIGGER IF EXISTS tenant_deposits_audit_trigger ON public.tenant_deposits;
...
DROP TRIGGER IF EXISTS maintenance_requests_audit_trigger ON public.maintenance_requests;
DROP TRIGGER IF EXISTS leases_audit_trigger ON public.leases;
DROP INDEX IF EXISTS public.idx_users_tenant_lookup;
DROP INDEX IF EXISTS public.idx_users_fulltext;
DROP INDEX IF EXISTS public.idx_units_with_rent;
...
DROP INDEX IF EXISTS public.idx_properties_fulltext;
DROP INDEX IF EXISTS public.idx_payments_revenue_analytics;
DROP INDEX IF EXISTS public.idx_payments_monthly_reports;
DROP INDEX IF EXISTS public.idx_leases_occupancy_report;
DROP INDEX IF EXISTS public.idx_invoices_unpaid;
DROP INDEX IF EXISTS public.idx_invoices_tenant_period;
...
ALTER TABLE IF EXISTS ONLY public.users DROP CONSTRAINT IF EXISTS users_replit_id_key;
ALTER TABLE IF EXISTS ONLY public.users DROP CONSTRAINT IF EXISTS users_pkey;
ALTER TABLE IF EXISTS ONLY public.users DROP CONSTRAINT IF EXISTS users_email_unique;
ALTER TABLE IF EXISTS ONLY public.user_access_requests DROP CONSTRAINT IF EXISTS user_access_requests_pkey;
ALTER TABLE IF EXISTS ONLY public.units DROP CONSTRAINT IF EXISTS units_pkey;
ALTER TABLE IF EXISTS ONLY public.unit_recurring_fees DROP CONSTRAINT IF EXISTS unit_recurring_fees_pkey;
ALTER TABLE IF EXISTS ONLY public.tenant_gadgets DROP CONSTRAINT IF EXISTS tenant_gadgets_pkey;
ALTER TABLE IF EXISTS ONLY public.tenant_documents DROP CONSTRAINT IF EXISTS tenant_documents_pkey;
ALTER TABLE IF EXISTS ONLY public.tenant_deposits DROP CONSTRAINT IF EXISTS tenant_deposits_pkey;
...
ALTER TABLE IF EXISTS ONLY public.property_recurring_fees DROP CONSTRAINT IF EXISTS property_recurring_fees_pkey;
ALTER TABLE IF EXISTS ONLY public.properties DROP CONSTRAINT IF EXISTS properties_pkey;
ALTER TABLE IF EXISTS ONLY public.payments DROP CONSTRAINT IF EXISTS payments_tx_id_key;
...
ALTER TABLE IF EXISTS ONLY public.leases DROP CONSTRAINT IF EXISTS leases_pkey;
...
ALTER TABLE IF EXISTS ONLY public.idempotency_keys DROP CONSTRAINT IF EXISTS idempotency_keys_key_key;
...
DROP TABLE IF EXISTS public.user_access_requests;
DROP TABLE IF EXISTS public.units;
DROP TABLE IF EXISTS public.unit_recurring_fees;
DROP TABLE IF EXISTS public.tenant_gadgets;
DROP TABLE IF EXISTS public.tenant_documents;
DROP TABLE IF EXISTS public.tenant_deposits;
DROP TABLE IF EXISTS public.sessions;
DROP TABLE IF EXISTS public.schema_migrations;
DROP TABLE IF EXISTS public.property_recurring_fees;
...
DROP FUNCTION IF EXISTS public.log_security_event(event_type text, user_id uuid, details jsonb, ip_address inet);
DROP FUNCTION IF EXISTS public.encrypt_sensitive_data(data text, key text);
DROP FUNCTION IF EXISTS public.decrypt_sensitive_data(encrypted_data text, key text);
DROP FUNCTION IF EXISTS public.check_user_permission(user_id uuid, required_role text);
...
DROP TYPE IF EXISTS public.recurring_period;
DROP TYPE IF EXISTS public.recurring_fee_type;
...
DROP TYPE IF EXISTS public.mpesa_type;
DROP TYPE IF EXISTS public.management_fee_type;
DROP TYPE IF EXISTS public.maintenance_status;
DROP TYPE IF EXISTS public.maintenance_priority;
DROP TYPE IF EXISTS public.maintenance_category;
DROP TYPE IF EXISTS public.lease_status;
DROP TYPE IF EXISTS public.invoice_status;
DROP TYPE IF EXISTS public.expenditure_category;
DROP TYPE IF EXISTS public.deposit_type;
...
--
-- Name: expenditure_category; Type: TYPE; Schema: public; Owner: -
--
...
--
-- Name: lease_status; Type: TYPE; Schema: public; Owner: -
--
...
--
-- Name: management_fee_type; Type: TYPE; Schema: public; Owner: -
--
...
--
-- Name: mpesa_type; Type: TYPE; Schema: public; Owner: -
--
...
--
-- Name: penalty_type; Type: TYPE; Schema: public; Owner: -
--
...
--
-- Name: recurring_fee_type; Type: TYPE; Schema: public; Owner: -
--
...
--
-- Name: decrypt_sensitive_data(text, text); Type: FUNCTION; Schema: public; Owner: -
--
...
--
-- Name: encrypt_sensitive_data(text, text); Type: FUNCTION; Schema: public; Owner: -
--
...
--
-- Name: log_security_event(text, uuid, jsonb, inet); Type: FUNCTION; Schema: public; Owner: -
--
...
CREATE TABLE public.invoices (
    ...
    period_month integer DEFAULT 1 NOT NULL,
    period_year integer DEFAULT 2025 NOT NULL
);
...
--
-- Name: property_recurring_fees; Type: TABLE; Schema: public; Owner: -
--
...
--
-- Name: tenant_deposits; Type: TABLE; Schema: public; Owner: -
--
...
--
-- Name: tenant_gadgets; Type: TABLE; Schema: public; Owner: -
--
...
--
-- Name: unit_recurring_fees; Type: TABLE; Schema: public; Owner: -
--
...
39	users	INSERT	\N	{"id": "a35934b4-b108-4be9-894a-967c257a8da9", "role": "tenant", "email": "ad@gmail.com", "phone": "0702198791", "kra_pin": null, "username": null, "is_active": true, "last_name": "ahine", "replit_id": null, "created_at": "2025-08-28T15:39:28.243302", "deleted_at": null, "deleted_by": null, "first_name": "Sharlune", "is_deleted": false, "updated_at": "2025-08-28T15:39:28.243302", "approved_at": null, "approved_by": null, "is_approved": false, "national_id": null, "password_hash": null, "alternate_phone": null, "emergency_contact_name": null, "emergency_contact_phone": null}	\N	\N	\N	\N	2025-08-28 15:39:28.243302+00	\N
40	properties	UPDATE	{"id": "a81805ea-efb4-423e-9108-751681104c5d", "city": "Nairobi", "name": "Test Property", "type": "apartment_complex", "state": "Nairobi", "status": "active", "address": "123 Test St", "owner_id": null, "tax_rate": 7.50, "zip_code": null, "created_at": "2025-08-27T15:29:57.695442", "deleted_at": null, "deleted_by": null, "is_deleted": false, "manager_id": null, "mpesa_type": null, "updated_at": "2025-08-27T15:29:57.695442", "water_rate": null, "description": null, "total_units": 5, "purchase_date": null, "purchase_price": null, "electricity_rate": null, "mpesa_till_number": null, "rent_penalty_type": null, "mpesa_store_number": null, "management_fee_type": null, "rent_penalty_amount": null, "mpesa_account_number": null, "mpesa_paybill_number": null, "management_fee_amount": null}	{"id": "a81805ea-efb4-423e-9108-751681104c5d", "city": "Nairobi", "name": "TURUKANA APTS", "type": "apartment_complex", "state": "Nairobi", "status": "active", "address": "123 Test St", "owner_id": null, "tax_rate": 7.50, "zip_code": null, "created_at": "2025-08-27T15:29:57.695442", "deleted_at": null, "deleted_by": null, "is_deleted": false, "manager_id": null, "mpesa_type": null, "updated_at": "2025-08-28T16:27:46.416", "water_rate": null, "description": null, "total_units": 5, "purchase_date": null, "purchase_price": null, "electricity_rate": null, "mpesa_till_number": null, "rent_penalty_type": null, "mpesa_store_number": null, "management_fee_type": null, "rent_penalty_amount": null, "mpesa_account_number": null, "mpesa_paybill_number": null, "management_fee_amount": null}	\N	\N	\N	\N	2025-08-28 16:27:46.568103+00	\N
41	properties	UPDATE	{"id": "f9b2e119-da66-40f4-a2d4-ea27a5dbad89", "city": "Nairobi", "name": "Test Property", "type": "apartment_complex", "state": "Nairobi", "status": "active", "address": "123 Test St", "owner_id": null, "tax_rate": 7.50, "zip_code": null, "created_at": "2025-08-27T19:54:44.814203", "deleted_at": null, "deleted_by": null, "is_deleted": false, "manager_id": null, "mpesa_type": null, "updated_at": "2025-08-27T19:54:44.814203", "water_rate": null, "description": null, "total_units": 5, "purchase_date": null, "purchase_price": null, "electricity_rate": null, "mpesa_till_number": null, "rent_penalty_type": null, "mpesa_store_number": null, "management_fee_type": null, "rent_penalty_amount": null, "mpesa_account_number": null, "mpesa_paybill_number": null, "management_fee_amount": null}	{"id": "f9b2e119-da66-40f4-a2d4-ea27a5dbad89", "city": "Nairobi", "name": "KOITALEL", "type": "apartment_complex", "state": "Nairobi", "status": "active", "address": "123 Test St", "owner_id": null, "tax_rate": 7.50, "zip_code": null, "created_at": "2025-08-27T19:54:44.814203", "deleted_at": null, "deleted_by": null, "is_deleted": false, "manager_id": null, "mpesa_type": null, "updated_at": "2025-08-28T16:28:03.928", "water_rate": null, "description": null, "total_units": 5, "purchase_date": null, "purchase_price": null, "electricity_rate": null, "mpesa_till_number": null, "rent_penalty_type": null, "mpesa_store_number": null, "management_fee_type": null, "rent_penalty_amount": null, "mpesa_account_number": null, "mpesa_paybill_number": null, "management_fee_amount": null}	\N	\N	\N	\N	2025-08-28 16:28:03.947621+00	\N
42	properties	INSERT	\N	{"id": "f36eb3c0-af11-4bd7-9adb-2de29135d5e5", "city": "Nairobi", "name": "QA Test Property", "type": "apartment_complex", "state": "Nairobi", "status": "active", "address": "123 Test Street", "owner_id": null, "tax_rate": 7.50, "zip_code": null, "created_at": "2025-08-28T17:22:23.80653", "deleted_at": null, "deleted_by": null, "is_deleted": false, "manager_id": null, "mpesa_type": null, "updated_at": "2025-08-28T17:22:23.80653", "water_rate": null, "description": null, "total_units": 5, "purchase_date": null, "purchase_price": null, "electricity_rate": null, "mpesa_till_number": null, "rent_penalty_type": null, "mpesa_store_number": null, "management_fee_type": null, "rent_penalty_amount": null, "mpesa_account_number": null, "mpesa_paybill_number": null, "management_fee_amount": null}	\N	\N	\N	\N	2025-08-28 17:22:23.80653+00	\N
43	properties	INSERT	\N	{"id": "4b54acdc-ad77-4c66-8faa-94fc0a6a6c3e", "city": "Nairobi", "name": "QA Test Property", "type": "apartment_complex", "state": "Nairobi", "status": "active", "address": "123 Test Street", "owner_id": null, "tax_rate": 7.50, "zip_code": null, "created_at": "2025-08-28T17:22:25.876974", "deleted_at": null, "deleted_by": null, "is_deleted": false, "manager_id": null, "mpesa_type": null, "updated_at": "2025-08-28T17:22:25.876974", "water_rate": null, "description": null, "total_units": 5, "purchase_date": null, "purchase_price": null, "electricity_rate": null, "mpesa_till_number": null, "rent_penalty_type": null, "mpesa_store_number": null, "management_fee_type": null, "rent_penalty_amount": null, "mpesa_account_number": null, "mpesa_paybill_number": null, "management_fee_amount": null}	\N	\N	\N	\N	2025-08-28 17:22:25.876974+00	\N
44	properties	UPDATE	{"id": "f36eb3c0-af11-4bd7-9adb-2de29135d5e5", "city": "Nairobi", "name": "QA Test Property", "type": "apartment_complex", "state": "Nairobi", "status": "active", "address": "123 Test Street", "owner_id": null, "tax_rate": 7.50, "zip_code": null, "created_at": "2025-08-28T17:22:23.80653", "deleted_at": null, "deleted_by": null, "is_deleted": false, "manager_id": null, "mpesa_type": null, "updated_at": "2025-08-28T17:22:23.80653", "water_rate": null, "description": null, "total_units": 5, "purchase_date": null, "purchase_price": null, "electricity_rate": null, "mpesa_till_number": null, "rent_penalty_type": null, "mpesa_store_number": null, "management_fee_type": null, "rent_penalty_amount": null, "mpesa_account_number": null, "mpesa_paybill_number": null, "management_fee_amount": null}	{"id": "f36eb3c0-af11-4bd7-9adb-2de29135d5e5", "city": "Nairobi", "name": "QA Test Property UPDATED", "type": "apartment_complex", "state": "Nairobi", "status": "active", "address": "123 Test Street", "owner_id": null, "tax_rate": 7.50, "zip_code": null, "created_at": "2025-08-28T17:22:23.80653", "deleted_at": null, "deleted_by": null, "is_deleted": false, "manager_id": null, "mpesa_type": null, "updated_at": "2025-08-28T17:22:37.326", "water_rate": null, "description": null, "total_units": 5, "purchase_date": null, "purchase_price": null, "electricity_rate": null, "mpesa_till_number": null, "rent_penalty_type": null, "mpesa_store_number": null, "management_fee_type": null, "rent_penalty_amount": null, "mpesa_account_number": null, "mpesa_paybill_number": null, "management_fee_amount": null}	\N	\N	\N	\N	2025-08-28 17:22:37.346855+00	\N
45	properties	DELETE	{"id": "4b54acdc-ad77-4c66-8faa-94fc0a6a6c3e", "city": "Nairobi", "name": "QA Test Property", "type": "apartment_complex", "state": "Nairobi", "status": "active", "address": "123 Test Street", "owner_id": null, "tax_rate": 7.50, "zip_code": null, "created_at": "2025-08-28T17:22:25.876974", "deleted_at": null, "deleted_by": null, "is_deleted": false, "manager_id": null, "mpesa_type": null, "updated_at": "2025-08-28T17:22:25.876974", "water_rate": null, "description": null, "total_units": 5, "purchase_date": null, "purchase_price": null, "electricity_rate": null, "mpesa_till_number": null, "rent_penalty_type": null, "mpesa_store_number": null, "management_fee_type": null, "rent_penalty_amount": null, "mpesa_account_number": null, "mpesa_paybill_number": null, "management_fee_amount": null}	\N	\N	\N	\N	\N	2025-08-28 17:22:39.45477+00	\N
46	units	INSERT	\N	{"id": "3581ef01-5960-4ac4-9771-c27b093f1365", "status": "vacant", "bedrooms": 2, "tax_rate": null, "bathrooms": 1.0, "unit_size": null, "created_at": "2025-08-28T17:23:37.196642", "deleted_at": null, "deleted_by": null, "is_deleted": false, "updated_at": "2025-08-28T17:23:37.196642", "description": null, "property_id": "f36eb3c0-af11-4bd7-9adb-2de29135d5e5", "square_feet": null, "unit_number": "QA-101", "monthly_rent": 25000.00, "security_deposit": null}	\N	\N	\N	\N	2025-08-28 17:23:37.196642+00	\N
47	units	INSERT	\N	{"id": "8c3e9444-ab16-4632-83ef-19f083861d6c", "status": "vacant", "bedrooms": 2, "tax_rate": null, "bathrooms": 1.0, "unit_size": null, "created_at": "2025-08-28T17:23:39.330994", "deleted_at": null, "deleted_by": null, "is_deleted": false, "updated_at": "2025-08-28T17:23:39.330994", "description": null, "property_id": "f36eb3c0-af11-4bd7-9adb-2de29135d5e5", "square_feet": null, "unit_number": "QA-101", "monthly_rent": 25000.00, "security_deposit": null}	\N	\N	\N	\N	2025-08-28 17:23:39.330994+00	\N
48	units	UPDATE	{"id": "3581ef01-5960-4ac4-9771-c27b093f1365", "status": "vacant", "bedrooms": 2, "tax_rate": null, "bathrooms": 1.0, "unit_size": null, "created_at": "2025-08-28T17:23:37.196642", "deleted_at": null, "deleted_by": null, "is_deleted": false, "updated_at": "2025-08-28T17:23:37.196642", "description": null, "property_id": "f36eb3c0-af11-4bd7-9adb-2de29135d5e5", "square_feet": null, "unit_number": "QA-101", "monthly_rent": 25000.00, "security_deposit": null}	{"id": "3581ef01-5960-4ac4-9771-c27b093f1365", "status": "vacant", "bedrooms": 2, "tax_rate": null, "bathrooms": 1.0, "unit_size": null, "created_at": "2025-08-28T17:23:37.196642", "deleted_at": null, "deleted_by": null, "is_deleted": false, "updated_at": "2025-08-28T17:23:47.835", "description": null, "property_id": "f36eb3c0-af11-4bd7-9adb-2de29135d5e5", "square_feet": null, "unit_number": "QA-101-UPDATED", "monthly_rent": 30000.00, "security_deposit": null}	\N	\N	\N	\N	2025-08-28 17:23:47.855816+00	\N
49	units	DELETE	{"id": "8c3e9444-ab16-4632-83ef-19f083861d6c", "status": "vacant", "bedrooms": 2, "tax_rate": null, "bathrooms": 1.0, "unit_size": null, "created_at": "2025-08-28T17:23:39.330994", "deleted_at": null, "deleted_by": null, "is_deleted": false, "updated_at": "2025-08-28T17:23:39.330994", "description": null, "property_id": "f36eb3c0-af11-4bd7-9adb-2de29135d5e5", "square_feet": null, "unit_number": "QA-101", "monthly_rent": 25000.00, "security_deposit": null}	\N	\N	\N	\N	\N	2025-08-28 17:23:48.632204+00	\N
50	users	INSERT	\N	{"id": "e32c34d0-86c6-47f9-950d-9b31f87a4aef", "role": "tenant", "email": "qa.tester@test.com", "phone": null, "kra_pin": null, "username": null, "is_active": true, "last_name": "Tester", "replit_id": null, "created_at": "2025-08-28T17:24:11.018047", "deleted_at": null, "deleted_by": null, "first_name": "QA", "is_deleted": false, "updated_at": "2025-08-28T17:24:11.018047", "approved_at": null, "approved_by": null, "is_approved": false, "national_id": null, "password_hash": null, "alternate_phone": null, "emergency_contact_name": null, "emergency_contact_phone": null}	\N	\N	\N	\N	2025-08-28 17:24:11.018047+00	\N
51	leases	INSERT	\N	{"id": "856de406-311d-44aa-ac89-d9ef72f701a9", "terms": null, "status": "active", "unit_id": "3581ef01-5960-4ac4-9771-c27b093f1365", "end_date": null, "tenant_id": "e32c34d0-86c6-47f9-950d-9b31f87a4aef", "created_at": "2025-08-28T17:24:11.092342", "deleted_at": null, "deleted_by": null, "is_deleted": false, "start_date": "2025-08-28T17:24:11.07", "updated_at": "2025-08-28T17:24:11.092342", "monthly_rent": 0.00, "move_in_date": "2025-08-28T17:24:11.07", "move_out_date": null, "move_out_reason": null, "security_deposit": 0.00, "move_out_notice_date": null}	\N	\N	\N	\N	2025-08-28 17:24:11.092342+00	\N
52	units	UPDATE	{"id": "3581ef01-5960-4ac4-9771-c27b093f1365", "status": "vacant", "bedrooms": 2, "tax_rate": null, "bathrooms": 1.0, "unit_size": null, "created_at": "2025-08-28T17:23:37.196642", "deleted_at": null, "deleted_by": null, "is_deleted": false, "updated_at": "2025-08-28T17:23:47.835", "description": null, "property_id": "f36eb3c0-af11-4bd7-9adb-2de29135d5e5", "square_feet": null, "unit_number": "QA-101-UPDATED", "monthly_rent": 30000.00, "security_deposit": null}	{"id": "3581ef01-5960-4ac4-9771-c27b093f1365", "status": "occupied", "bedrooms": 2, "tax_rate": null, "bathrooms": 1.0, "unit_size": null, "created_at": "2025-08-28T17:23:37.196642", "deleted_at": null, "deleted_by": null, "is_deleted": false, "updated_at": "2025-08-28T17:23:47.835", "description": null, "property_id": "f36eb3c0-af11-4bd7-9adb-2de29135d5e5", "square_feet": null, "unit_number": "QA-101-UPDATED", "monthly_rent": 30000.00, "security_deposit": null}	\N	\N	\N	\N	2025-08-28 17:24:11.135855+00	\N
53	users	UPDATE	{"id": "e32c34d0-86c6-47f9-950d-9b31f87a4aef", "role": "tenant", "email": "qa.tester@test.com", "phone": null, "kra_pin": null, "username": null, "is_active": true, "last_name": "Tester", "replit_id": null, "created_at": "2025-08-28T17:24:11.018047", "deleted_at": null, "deleted_by": null, "first_name": "QA", "is_deleted": false, "updated_at": "2025-08-28T17:24:11.018047", "approved_at": null, "approved_by": null, "is_approved": false, "national_id": null, "password_hash": null, "alternate_phone": null, "emergency_contact_name": null, "emergency_contact_phone": null}	{"id": "e32c34d0-86c6-47f9-950d-9b31f87a4aef", "role": "tenant", "email": "qa.tester@test.com", "phone": null, "kra_pin": null, "username": null, "is_active": true, "last_name": "Tester", "replit_id": null, "created_at": "2025-08-28T17:24:11.018047", "deleted_at": null, "deleted_by": null, "first_name": "QA", "is_deleted": false, "updated_at": "2025-08-28T17:24:11.154", "approved_at": null, "approved_by": null, "is_approved": true, "national_id": null, "password_hash": null, "alternate_phone": null, "emergency_contact_name": null, "emergency_contact_phone": null}	\N	\N	\N	\N	2025-08-28 17:24:11.174356+00	\N
54	units	UPDATE	{"id": "3581ef01-5960-4ac4-9771-c27b093f1365", "status": "occupied", "bedrooms": 2, "tax_rate": null, "bathrooms": 1.0, "unit_size": null, "created_at": "2025-08-28T17:23:37.196642", "deleted_at": null, "deleted_by": null, "is_deleted": false, "updated_at": "2025-08-28T17:23:47.835", "description": null, "property_id": "f36eb3c0-af11-4bd7-9adb-2de29135d5e5", "square_feet": null, "unit_number": "QA-101-UPDATED", "monthly_rent": 30000.00, "security_deposit": null}	{"id": "3581ef01-5960-4ac4-9771-c27b093f1365", "status": "occupied", "bedrooms": 2, "tax_rate": null, "bathrooms": 1.0, "unit_size": null, "created_at": "2025-08-28T17:23:37.196642", "deleted_at": null, "deleted_by": null, "is_deleted": false, "updated_at": "2025-08-28T17:24:11.193", "description": null, "property_id": "f36eb3c0-af11-4bd7-9adb-2de29135d5e5", "square_feet": null, "unit_number": "QA-101-UPDATED", "monthly_rent": 30000.00, "security_deposit": null}	\N	\N	\N	\N	2025-08-28 17:24:11.21291+00	\N
55	units	DELETE	{"id": "28b5daac-7beb-491b-abe7-52f9d5c0f9c4", "status": "vacant", "bedrooms": 0, "tax_rate": null, "bathrooms": 1.0, "unit_size": null, "created_at": "2025-08-28T15:00:31.391898", "deleted_at": null, "deleted_by": null, "is_deleted": false, "updated_at": "2025-08-28T15:00:31.391898", "description": null, "property_id": "861621ec-f769-4be8-98d9-92a006a1ce99", "square_feet": 600, "unit_number": "Shop-G1", "monthly_rent": 120000.00, "security_deposit": 240000.00}	\N	\N	\N	\N	\N	2025-08-28 17:27:50.711937+00	\N
56	properties	INSERT	\N	{"id": "912aa8d9-65dd-45a4-b41e-2a492dcf5970", "city": "Nairobi", "name": "QA Test Property UPDATED", "type": "apartment_complex", "state": "Nairobi", "status": "active", "address": "123 Test Street", "owner_id": null, "tax_rate": 7.50, "zip_code": null, "created_at": "2025-08-28T17:30:24.408226", "deleted_at": null, "deleted_by": null, "is_deleted": false, "manager_id": null, "mpesa_type": null, "updated_at": "2025-08-28T17:30:24.408226", "water_rate": null, "description": null, "total_units": 5, "purchase_date": null, "purchase_price": null, "electricity_rate": null, "mpesa_till_number": null, "rent_penalty_type": null, "mpesa_store_number": null, "management_fee_type": null, "rent_penalty_amount": null, "mpesa_account_number": null, "mpesa_paybill_number": null, "management_fee_amount": null}	\N	\N	\N	\N	2025-08-28 17:30:24.408226+00	\N
57	units	INSERT	\N	{"id": "b842cc5e-809c-4db2-b955-3c9542ca82c1", "status": "vacant", "bedrooms": 2, "tax_rate": null, "bathrooms": 1.0, "unit_size": null, "created_at": "2025-08-28T17:30:27.821408", "deleted_at": null, "deleted_by": null, "is_deleted": false, "updated_at": "2025-08-28T17:30:27.821408", "description": null, "property_id": "f36eb3c0-af11-4bd7-9adb-2de29135d5e5", "square_feet": null, "unit_number": "QA-101-UPDATED", "monthly_rent": 25000.00, "security_deposit": null}	\N	\N	\N	\N	2025-08-28 17:30:27.821408+00	\N
58	users	INSERT	\N	{"id": "60345685-88fb-4b28-8bdf-4a26314b80c6", "role": "tenant", "email": "qa.tenant.fixed@test.com", "phone": "0700123456", "kra_pin": null, "username": null, "is_active": true, "last_name": "Tenant", "replit_id": null, "created_at": "2025-08-28T17:30:56.70168", "deleted_at": null, "deleted_by": null, "first_name": "QA", "is_deleted": false, "updated_at": "2025-08-28T17:30:56.70168", "approved_at": null, "approved_by": null, "is_approved": false, "national_id": null, "password_hash": null, "alternate_phone": null, "emergency_contact_name": null, "emergency_contact_phone": null}	\N	\N	\N	\N	2025-08-28 17:30:56.70168+00	\N
59	leases	INSERT	\N	{"id": "454a6b1c-fa70-401f-b1ab-60e5a3b2f4e3", "terms": null, "status": "active", "unit_id": "3581ef01-5960-4ac4-9771-c27b093f1365", "end_date": null, "tenant_id": "60345685-88fb-4b28-8bdf-4a26314b80c6", "created_at": "2025-08-28T17:30:56.74792", "deleted_at": null, "deleted_by": null, "is_deleted": false, "start_date": "2025-08-28T00:00:00", "updated_at": "2025-08-28T17:30:56.74792", "monthly_rent": 30000.00, "move_in_date": "2025-08-28T17:30:56.726", "move_out_date": null, "move_out_reason": null, "security_deposit": 0.00, "move_out_notice_date": null}	\N	\N	\N	\N	2025-08-28 17:30:56.74792+00	\N
60	units	UPDATE	{"id": "3581ef01-5960-4ac4-9771-c27b093f1365", "status": "occupied", "bedrooms": 2, "tax_rate": null, "bathrooms": 1.0, "unit_size": null, "created_at": "2025-08-28T17:23:37.196642", "deleted_at": null, "deleted_by": null, "is_deleted": false, "updated_at": "2025-08-28T17:24:11.193", "description": null, "property_id": "f36eb3c0-af11-4bd7-9adb-2de29135d5e5", "square_feet": null, "unit_number": "QA-101-UPDATED", "monthly_rent": 30000.00, "security_deposit": null}	{"id": "3581ef01-5960-4ac4-9771-c27b093f1365", "status": "occupied", "bedrooms": 2, "tax_rate": null, "bathrooms": 1.0, "unit_size": null, "created_at": "2025-08-28T17:23:37.196642", "deleted_at": null, "deleted_by": null, "is_deleted": false, "updated_at": "2025-08-28T17:24:11.193", "description": null, "property_id": "f36eb3c0-af11-4bd7-9adb-2de29135d5e5", "square_feet": null, "unit_number": "QA-101-UPDATED", "monthly_rent": 30000.00, "security_deposit": null}	\N	\N	\N	\N	2025-08-28 17:30:56.789427+00	\N
84	leases	INSERT	\N	{"id": "f0e1ebac-5ae4-41de-a63b-577ba92edbe4", "terms": null, "status": "active", "unit_id": "41617cbe-0e5d-4341-a2b0-c03f977c14a2", "end_date": "2026-08-28T00:00:00", "tenant_id": "e5936f37-2444-47c2-a6e0-0d91653f4778", "created_at": "2025-08-28T19:37:11.498713", "deleted_at": null, "deleted_by": null, "is_deleted": false, "start_date": "2025-08-28T00:00:00", "updated_at": "2025-08-28T19:37:11.498713", "monthly_rent": 20000.00, "move_in_date": "2025-08-28T00:00:00", "move_out_date": null, "move_out_reason": null, "security_deposit": 20000.00, "move_out_notice_date": null}	\N	\N	\N	\N	2025-08-28 19:37:11.498713+00	\N
61	users	UPDATE	{"id": "60345685-88fb-4b28-8bdf-4a26314b80c6", "role": "tenant", "email": "qa.tenant.fixed@test.com", "phone": "0700123456", "kra_pin": null, "username": null, "is_active": true, "last_name": "Tenant", "replit_id": null, "created_at": "2025-08-28T17:30:56.70168", "deleted_at": null, "deleted_by": null, "first_name": "QA", "is_deleted": false, "updated_at": "2025-08-28T17:30:56.70168", "approved_at": null, "approved_by": null, "is_approved": false, "national_id": null, "password_hash": null, "alternate_phone": null, "emergency_contact_name": null, "emergency_contact_phone": null}	{"id": "60345685-88fb-4b28-8bdf-4a26314b80c6", "role": "tenant", "email": "qa.tenant.fixed@test.com", "phone": "0700123456", "kra_pin": null, "username": null, "is_active": true, "last_name": "Tenant", "replit_id": null, "created_at": "2025-08-28T17:30:56.70168", "deleted_at": null, "deleted_by": null, "first_name": "QA", "is_deleted": false, "updated_at": "2025-08-28T17:30:56.808", "approved_at": null, "approved_by": null, "is_approved": true, "national_id": null, "password_hash": null, "alternate_phone": null, "emergency_contact_name": null, "emergency_contact_phone": null}	\N	\N	\N	\N	2025-08-28 17:30:56.827214+00	\N
62	units	UPDATE	{"id": "3581ef01-5960-4ac4-9771-c27b093f1365", "status": "occupied", "bedrooms": 2, "tax_rate": null, "bathrooms": 1.0, "unit_size": null, "created_at": "2025-08-28T17:23:37.196642", "deleted_at": null, "deleted_by": null, "is_deleted": false, "updated_at": "2025-08-28T17:24:11.193", "description": null, "property_id": "f36eb3c0-af11-4bd7-9adb-2de29135d5e5", "square_feet": null, "unit_number": "QA-101-UPDATED", "monthly_rent": 30000.00, "security_deposit": null}	{"id": "3581ef01-5960-4ac4-9771-c27b093f1365", "status": "occupied", "bedrooms": 2, "tax_rate": null, "bathrooms": 1.0, "unit_size": null, "created_at": "2025-08-28T17:23:37.196642", "deleted_at": null, "deleted_by": null, "is_deleted": false, "updated_at": "2025-08-28T17:30:56.846", "description": null, "property_id": "f36eb3c0-af11-4bd7-9adb-2de29135d5e5", "square_feet": null, "unit_number": "QA-101-UPDATED", "monthly_rent": 30000.00, "security_deposit": null}	\N	\N	\N	\N	2025-08-28 17:30:56.865974+00	\N
63	properties	DELETE	{"id": "861621ec-f769-4be8-98d9-92a006a1ce99", "city": "Nairobi", "name": "Downtown Commercial Plaza", "type": "commercial", "state": "Nairobi County", "status": "active", "address": "789 Moi Avenue, Nairobi", "owner_id": null, "tax_rate": 7.50, "zip_code": null, "created_at": "2025-08-28T15:00:08.913676", "deleted_at": null, "deleted_by": null, "is_deleted": false, "manager_id": null, "mpesa_type": null, "updated_at": "2025-08-28T15:00:08.913676", "water_rate": null, "description": "Prime commercial space in downtown Nairobi", "total_units": 0, "purchase_date": null, "purchase_price": null, "electricity_rate": null, "mpesa_till_number": null, "rent_penalty_type": null, "mpesa_store_number": null, "management_fee_type": null, "rent_penalty_amount": null, "mpesa_account_number": null, "mpesa_paybill_number": null, "management_fee_amount": null}	\N	\N	\N	\N	\N	2025-08-28 17:42:51.322731+00	\N
64	properties	DELETE	{"id": "dd48807d-8742-439a-adfd-0d5c9229410b", "city": "Nairobi", "name": "Modern Test", "type": "apartment_complex", "state": "Nairobi", "status": "active", "address": "123 Modern St", "owner_id": null, "tax_rate": 7.50, "zip_code": null, "created_at": "2025-08-27T20:04:37.802334", "deleted_at": null, "deleted_by": null, "is_deleted": false, "manager_id": null, "mpesa_type": null, "updated_at": "2025-08-27T20:04:37.802334", "water_rate": null, "description": null, "total_units": 3, "purchase_date": null, "purchase_price": null, "electricity_rate": null, "mpesa_till_number": null, "rent_penalty_type": null, "mpesa_store_number": null, "management_fee_type": null, "rent_penalty_amount": null, "mpesa_account_number": null, "mpesa_paybill_number": null, "management_fee_amount": null}	\N	\N	\N	\N	\N	2025-08-28 17:42:59.053927+00	\N
65	leases	INSERT	\N	{"id": "66fe9857-afc0-4ecf-ab25-5956c2dfabc1", "terms": null, "status": "pending", "unit_id": "f344f75e-6f7e-401a-9a27-b3d3085f9f87", "end_date": "2025-12-31T00:00:00", "tenant_id": "524633e8-667b-4a00-9346-25c7fe8e3e54", "created_at": "2025-08-28T17:53:02.509144", "deleted_at": null, "deleted_by": null, "is_deleted": false, "start_date": "2025-01-01T00:00:00", "updated_at": "2025-08-28T17:53:02.509144", "monthly_rent": 25000.00, "move_in_date": "2025-01-01T00:00:00", "move_out_date": null, "move_out_reason": null, "security_deposit": 25000.00, "move_out_notice_date": null}	\N	\N	\N	\N	2025-08-28 17:53:02.509144+00	\N
66	units	UPDATE	{"id": "f344f75e-6f7e-401a-9a27-b3d3085f9f87", "status": "occupied", "bedrooms": 1, "tax_rate": null, "bathrooms": 1.0, "unit_size": null, "created_at": "2025-08-27T15:51:13.893333", "deleted_at": null, "deleted_by": null, "is_deleted": false, "updated_at": "2025-08-28T14:49:18.916", "description": "One bedroom apartment near town center with parking", "property_id": "e6248e10-7d91-4f2c-8202-a3516c554478", "square_feet": 480, "unit_number": "EP1", "monthly_rent": 25000.00, "security_deposit": 25000.00}	{"id": "f344f75e-6f7e-401a-9a27-b3d3085f9f87", "status": "occupied", "bedrooms": 1, "tax_rate": null, "bathrooms": 1.0, "unit_size": null, "created_at": "2025-08-27T15:51:13.893333", "deleted_at": null, "deleted_by": null, "is_deleted": false, "updated_at": "2025-08-28T14:49:18.916", "description": "One bedroom apartment near town center with parking", "property_id": "e6248e10-7d91-4f2c-8202-a3516c554478", "square_feet": 480, "unit_number": "EP1", "monthly_rent": 25000.00, "security_deposit": 25000.00}	\N	\N	\N	\N	2025-08-28 17:53:02.56431+00	\N
67	users	UPDATE	{"id": "524633e8-667b-4a00-9346-25c7fe8e3e54", "role": "tenant", "email": "john.doe@example.com", "phone": "555-123-4567", "kra_pin": null, "username": null, "is_active": true, "last_name": "Doe", "replit_id": null, "created_at": "2025-08-27T14:46:16.369373", "deleted_at": null, "deleted_by": null, "first_name": "John", "is_deleted": false, "updated_at": "2025-08-27T14:46:16.369373", "approved_at": null, "approved_by": null, "is_approved": false, "national_id": null, "password_hash": null, "alternate_phone": null, "emergency_contact_name": null, "emergency_contact_phone": null}	{"id": "524633e8-667b-4a00-9346-25c7fe8e3e54", "role": "tenant", "email": "john.doe@example.com", "phone": "555-123-4567", "kra_pin": null, "username": null, "is_active": true, "last_name": "Doe", "replit_id": null, "created_at": "2025-08-27T14:46:16.369373", "deleted_at": null, "deleted_by": null, "first_name": "John", "is_deleted": false, "updated_at": "2025-08-28T17:53:02.583", "approved_at": null, "approved_by": null, "is_approved": true, "national_id": null, "password_hash": null, "alternate_phone": null, "emergency_contact_name": null, "emergency_contact_phone": null}	\N	\N	\N	\N	2025-08-28 17:53:02.601896+00	\N
68	leases	INSERT	\N	{"id": "9419bd2a-d2fc-4b52-8d01-7b0b099125f0", "terms": null, "status": "active", "unit_id": "f344f75e-6f7e-401a-9a27-b3d3085f9f87", "end_date": "2025-12-31T00:00:00", "tenant_id": "a35934b4-b108-4be9-894a-967c257a8da9", "created_at": "2025-08-28T17:53:21.587376", "deleted_at": null, "deleted_by": null, "is_deleted": false, "start_date": "2025-01-01T00:00:00", "updated_at": "2025-08-28T17:53:21.587376", "monthly_rent": 18000.00, "move_in_date": "2025-01-01T00:00:00", "move_out_date": null, "move_out_reason": null, "security_deposit": 18000.00, "move_out_notice_date": null}	\N	\N	\N	\N	2025-08-28 17:53:21.587376+00	\N
69	units	UPDATE	{"id": "f344f75e-6f7e-401a-9a27-b3d3085f9f87", "status": "occupied", "bedrooms": 1, "tax_rate": null, "bathrooms": 1.0, "unit_size": null, "created_at": "2025-08-27T15:51:13.893333", "deleted_at": null, "deleted_by": null, "is_deleted": false, "updated_at": "2025-08-28T14:49:18.916", "description": "One bedroom apartment near town center with parking", "property_id": "e6248e10-7d91-4f2c-8202-a3516c554478", "square_feet": 480, "unit_number": "EP1", "monthly_rent": 25000.00, "security_deposit": 25000.00}	{"id": "f344f75e-6f7e-401a-9a27-b3d3085f9f87", "status": "occupied", "bedrooms": 1, "tax_rate": null, "bathrooms": 1.0, "unit_size": null, "created_at": "2025-08-27T15:51:13.893333", "deleted_at": null, "deleted_by": null, "is_deleted": false, "updated_at": "2025-08-28T14:49:18.916", "description": "One bedroom apartment near town center with parking", "property_id": "e6248e10-7d91-4f2c-8202-a3516c554478", "square_feet": 480, "unit_number": "EP1", "monthly_rent": 25000.00, "security_deposit": 25000.00}	\N	\N	\N	\N	2025-08-28 17:53:21.624915+00	\N
70	users	UPDATE	{"id": "a35934b4-b108-4be9-894a-967c257a8da9", "role": "tenant", "email": "ad@gmail.com", "phone": "0702198791", "kra_pin": null, "username": null, "is_active": true, "last_name": "ahine", "replit_id": null, "created_at": "2025-08-28T15:39:28.243302", "deleted_at": null, "deleted_by": null, "first_name": "Sharlune", "is_deleted": false, "updated_at": "2025-08-28T15:39:28.243302", "approved_at": null, "approved_by": null, "is_approved": false, "national_id": null, "password_hash": null, "alternate_phone": null, "emergency_contact_name": null, "emergency_contact_phone": null}	{"id": "a35934b4-b108-4be9-894a-967c257a8da9", "role": "tenant", "email": "ad@gmail.com", "phone": "0702198791", "kra_pin": null, "username": null, "is_active": true, "last_name": "ahine", "replit_id": null, "created_at": "2025-08-28T15:39:28.243302", "deleted_at": null, "deleted_by": null, "first_name": "Sharlune", "is_deleted": false, "updated_at": "2025-08-28T17:53:21.643", "approved_at": null, "approved_by": null, "is_approved": true, "national_id": null, "password_hash": null, "alternate_phone": null, "emergency_contact_name": null, "emergency_contact_phone": null}	\N	\N	\N	\N	2025-08-28 17:53:21.661961+00	\N
71	leases	INSERT	\N	{"id": "c6225d77-31ce-42ae-b1fc-5d9613edf3df", "terms": null, "status": "active", "unit_id": "c0e705e1-bfb3-40e7-ab60-653610303e58", "end_date": "2026-08-28T00:00:00", "tenant_id": "9975884a-6ff5-4bdd-b05d-822b00dac43d", "created_at": "2025-08-28T17:53:50.660987", "deleted_at": null, "deleted_by": null, "is_deleted": false, "start_date": "2025-08-28T00:00:00", "updated_at": "2025-08-28T17:53:50.660987", "monthly_rent": 20000.00, "move_in_date": "2025-08-28T00:00:00", "move_out_date": null, "move_out_reason": null, "security_deposit": 20000.00, "move_out_notice_date": null}	\N	\N	\N	\N	2025-08-28 17:53:50.660987+00	\N
72	units	UPDATE	{"id": "c0e705e1-bfb3-40e7-ab60-653610303e58", "status": "vacant", "bedrooms": 1, "tax_rate": null, "bathrooms": 1.0, "unit_size": null, "created_at": "2025-08-27T15:51:13.893333", "deleted_at": null, "deleted_by": null, "is_deleted": false, "updated_at": "2025-08-27T15:51:13.893333", "description": "One bedroom apartment near town center with parking", "property_id": "e6248e10-7d91-4f2c-8202-a3516c554478", "square_feet": 480, "unit_number": "EP10", "monthly_rent": 25000.00, "security_deposit": 25000.00}	{"id": "c0e705e1-bfb3-40e7-ab60-653610303e58", "status": "occupied", "bedrooms": 1, "tax_rate": null, "bathrooms": 1.0, "unit_size": null, "created_at": "2025-08-27T15:51:13.893333", "deleted_at": null, "deleted_by": null, "is_deleted": false, "updated_at": "2025-08-27T15:51:13.893333", "description": "One bedroom apartment near town center with parking", "property_id": "e6248e10-7d91-4f2c-8202-a3516c554478", "square_feet": 480, "unit_number": "EP10", "monthly_rent": 25000.00, "security_deposit": 25000.00}	\N	\N	\N	\N	2025-08-28 17:53:50.705573+00	\N
73	users	UPDATE	{"id": "9975884a-6ff5-4bdd-b05d-822b00dac43d", "role": "tenant", "email": "superadmin@school.com", "phone": "0867768723943", "kra_pin": null, "username": null, "is_active": true, "last_name": "Alex", "replit_id": null, "created_at": "2025-08-27T15:02:44.380938", "deleted_at": null, "deleted_by": null, "first_name": "Kwame", "is_deleted": false, "updated_at": "2025-08-27T15:02:44.380938", "approved_at": null, "approved_by": null, "is_approved": false, "national_id": null, "password_hash": null, "alternate_phone": null, "emergency_contact_name": null, "emergency_contact_phone": null}	{"id": "9975884a-6ff5-4bdd-b05d-822b00dac43d", "role": "tenant", "email": "superadmin@school.com", "phone": "0867768723943", "kra_pin": null, "username": null, "is_active": true, "last_name": "Alex", "replit_id": null, "created_at": "2025-08-27T15:02:44.380938", "deleted_at": null, "deleted_by": null, "first_name": "Kwame", "is_deleted": false, "updated_at": "2025-08-28T17:53:50.726", "approved_at": null, "approved_by": null, "is_approved": true, "national_id": null, "password_hash": null, "alternate_phone": null, "emergency_contact_name": null, "emergency_contact_phone": null}	\N	\N	\N	\N	2025-08-28 17:53:50.745661+00	\N
74	leases	INSERT	\N	{"id": "313ba910-6da1-49b9-ab95-7f854ecf3270", "terms": null, "status": "active", "unit_id": "6d243dca-f7e5-4608-93b6-03fd5cabdc38", "end_date": "2026-08-28T00:00:00", "tenant_id": "8c6c5d2a-c1c8-4cd6-a973-2e6b2f2e6246", "created_at": "2025-08-28T18:04:00.447777", "deleted_at": null, "deleted_by": null, "is_deleted": false, "start_date": "2025-08-28T00:00:00", "updated_at": "2025-08-28T18:04:00.447777", "monthly_rent": 20000.00, "move_in_date": "2025-08-28T00:00:00", "move_out_date": null, "move_out_reason": null, "security_deposit": 20000.00, "move_out_notice_date": null}	\N	\N	\N	\N	2025-08-28 18:04:00.447777+00	\N
75	units	UPDATE	{"id": "6d243dca-f7e5-4608-93b6-03fd5cabdc38", "status": "vacant", "bedrooms": 1, "tax_rate": null, "bathrooms": 1.0, "unit_size": null, "created_at": "2025-08-27T15:51:13.893333", "deleted_at": null, "deleted_by": null, "is_deleted": false, "updated_at": "2025-08-27T15:51:13.893333", "description": "One bedroom apartment near town center with parking", "property_id": "e6248e10-7d91-4f2c-8202-a3516c554478", "square_feet": 480, "unit_number": "EP13", "monthly_rent": 25000.00, "security_deposit": 25000.00}	{"id": "6d243dca-f7e5-4608-93b6-03fd5cabdc38", "status": "occupied", "bedrooms": 1, "tax_rate": null, "bathrooms": 1.0, "unit_size": null, "created_at": "2025-08-27T15:51:13.893333", "deleted_at": null, "deleted_by": null, "is_deleted": false, "updated_at": "2025-08-27T15:51:13.893333", "description": "One bedroom apartment near town center with parking", "property_id": "e6248e10-7d91-4f2c-8202-a3516c554478", "square_feet": 480, "unit_number": "EP13", "monthly_rent": 25000.00, "security_deposit": 25000.00}	\N	\N	\N	\N	2025-08-28 18:04:00.511456+00	\N
76	users	UPDATE	{"id": "8c6c5d2a-c1c8-4cd6-a973-2e6b2f2e6246", "role": "tenant", "email": "test@example.com", "phone": "123456789", "kra_pin": null, "username": null, "is_active": true, "last_name": "User", "replit_id": null, "created_at": "2025-08-27T15:15:51.187544", "deleted_at": null, "deleted_by": null, "first_name": "Test", "is_deleted": false, "updated_at": "2025-08-27T15:15:51.187544", "approved_at": null, "approved_by": null, "is_approved": false, "national_id": null, "password_hash": null, "alternate_phone": null, "emergency_contact_name": null, "emergency_contact_phone": null}	{"id": "8c6c5d2a-c1c8-4cd6-a973-2e6b2f2e6246", "role": "tenant", "email": "test@example.com", "phone": "123456789", "kra_pin": null, "username": null, "is_active": true, "last_name": "User", "replit_id": null, "created_at": "2025-08-27T15:15:51.187544", "deleted_at": null, "deleted_by": null, "first_name": "Test", "is_deleted": false, "updated_at": "2025-08-28T18:04:00.532", "approved_at": null, "approved_by": null, "is_approved": true, "national_id": null, "password_hash": null, "alternate_phone": null, "emergency_contact_name": null, "emergency_contact_phone": null}	\N	\N	\N	\N	2025-08-28 18:04:00.549856+00	\N
77	leases	INSERT	\N	{"id": "07d98fb5-4090-4ae7-9d35-5c7791d4a25c", "terms": null, "status": "active", "unit_id": "313a491b-9644-478d-8860-97b184c9da8c", "end_date": "2026-08-28T00:00:00", "tenant_id": "aca97846-a7d3-413d-ad79-05336a6cf855", "created_at": "2025-08-28T18:04:06.519756", "deleted_at": null, "deleted_by": null, "is_deleted": false, "start_date": "2025-08-28T00:00:00", "updated_at": "2025-08-28T18:04:06.519756", "monthly_rent": 20000.00, "move_in_date": "2025-08-28T00:00:00", "move_out_date": null, "move_out_reason": null, "security_deposit": 20000.00, "move_out_notice_date": null}	\N	\N	\N	\N	2025-08-28 18:04:06.519756+00	\N
78	units	UPDATE	{"id": "313a491b-9644-478d-8860-97b184c9da8c", "status": "vacant", "bedrooms": 2, "tax_rate": null, "bathrooms": 1.0, "unit_size": null, "created_at": "2025-08-27T15:51:13.893333", "deleted_at": null, "deleted_by": null, "is_deleted": false, "updated_at": "2025-08-27T15:51:13.893333", "description": "Two bedroom with modern kitchen and backup power", "property_id": "e6248e10-7d91-4f2c-8202-a3516c554478", "square_feet": 650, "unit_number": "EP11", "monthly_rent": 35000.00, "security_deposit": 35000.00}	{"id": "313a491b-9644-478d-8860-97b184c9da8c", "status": "occupied", "bedrooms": 2, "tax_rate": null, "bathrooms": 1.0, "unit_size": null, "created_at": "2025-08-27T15:51:13.893333", "deleted_at": null, "deleted_by": null, "is_deleted": false, "updated_at": "2025-08-27T15:51:13.893333", "description": "Two bedroom with modern kitchen and backup power", "property_id": "e6248e10-7d91-4f2c-8202-a3516c554478", "square_feet": 650, "unit_number": "EP11", "monthly_rent": 35000.00, "security_deposit": 35000.00}	\N	\N	\N	\N	2025-08-28 18:04:06.557636+00	\N
79	users	UPDATE	{"id": "aca97846-a7d3-413d-ad79-05336a6cf855", "role": "tenant", "email": "admin@school.co.ke", "phone": "2345675", "kra_pin": null, "username": null, "is_active": true, "last_name": "Achieng", "replit_id": null, "created_at": "2025-08-27T15:26:29.406902", "deleted_at": null, "deleted_by": null, "first_name": "Kwame", "is_deleted": false, "updated_at": "2025-08-27T15:26:29.406902", "approved_at": null, "approved_by": null, "is_approved": false, "national_id": null, "password_hash": null, "alternate_phone": null, "emergency_contact_name": null, "emergency_contact_phone": null}	{"id": "aca97846-a7d3-413d-ad79-05336a6cf855", "role": "tenant", "email": "admin@school.co.ke", "phone": "2345675", "kra_pin": null, "username": null, "is_active": true, "last_name": "Achieng", "replit_id": null, "created_at": "2025-08-27T15:26:29.406902", "deleted_at": null, "deleted_by": null, "first_name": "Kwame", "is_deleted": false, "updated_at": "2025-08-28T18:04:06.577", "approved_at": null, "approved_by": null, "is_approved": true, "national_id": null, "password_hash": null, "alternate_phone": null, "emergency_contact_name": null, "emergency_contact_phone": null}	\N	\N	\N	\N	2025-08-28 18:04:06.596998+00	\N
81	leases	INSERT	\N	{"id": "01f9fb28-0b2b-4855-92fe-ba199c0d9673", "terms": null, "status": "active", "unit_id": "579511fd-d630-4279-98aa-633a3223eec7", "end_date": "2026-08-28T00:00:00", "tenant_id": "11ca1000-416a-4fe9-8561-f6bf6b204d90", "created_at": "2025-08-28T19:35:38.874417", "deleted_at": null, "deleted_by": null, "is_deleted": false, "start_date": "2025-08-28T00:00:00", "updated_at": "2025-08-28T19:35:38.874417", "monthly_rent": 20000.00, "move_in_date": "2025-08-28T00:00:00", "move_out_date": null, "move_out_reason": null, "security_deposit": 20000.00, "move_out_notice_date": null}	\N	\N	\N	\N	2025-08-28 19:35:38.874417+00	\N
82	units	UPDATE	{"id": "579511fd-d630-4279-98aa-633a3223eec7", "status": "vacant", "bedrooms": 2, "tax_rate": null, "bathrooms": 1.0, "unit_size": null, "created_at": "2025-08-27T15:51:13.893333", "deleted_at": null, "deleted_by": null, "is_deleted": false, "updated_at": "2025-08-27T15:51:13.893333", "description": "Two bedroom with modern kitchen and backup power", "property_id": "e6248e10-7d91-4f2c-8202-a3516c554478", "square_feet": 650, "unit_number": "EP14", "monthly_rent": 35000.00, "security_deposit": 35000.00}	{"id": "579511fd-d630-4279-98aa-633a3223eec7", "status": "occupied", "bedrooms": 2, "tax_rate": null, "bathrooms": 1.0, "unit_size": null, "created_at": "2025-08-27T15:51:13.893333", "deleted_at": null, "deleted_by": null, "is_deleted": false, "updated_at": "2025-08-27T15:51:13.893333", "description": "Two bedroom with modern kitchen and backup power", "property_id": "e6248e10-7d91-4f2c-8202-a3516c554478", "square_feet": 650, "unit_number": "EP14", "monthly_rent": 35000.00, "security_deposit": 35000.00}	\N	\N	\N	\N	2025-08-28 19:35:38.922109+00	\N
83	users	UPDATE	{"id": "11ca1000-416a-4fe9-8561-f6bf6b204d90", "role": "tenant", "email": "test2@example.com", "phone": "123456789", "kra_pin": null, "username": null, "is_active": true, "last_name": "User", "replit_id": null, "created_at": "2025-08-27T15:30:12.168795", "deleted_at": null, "deleted_by": null, "first_name": "Test", "is_deleted": false, "updated_at": "2025-08-27T15:30:12.168795", "approved_at": null, "approved_by": null, "is_approved": false, "national_id": null, "password_hash": null, "alternate_phone": null, "emergency_contact_name": null, "emergency_contact_phone": null}	{"id": "11ca1000-416a-4fe9-8561-f6bf6b204d90", "role": "tenant", "email": "test2@example.com", "phone": "123456789", "kra_pin": null, "username": null, "is_active": true, "last_name": "User", "replit_id": null, "created_at": "2025-08-27T15:30:12.168795", "deleted_at": null, "deleted_by": null, "first_name": "Test", "is_deleted": false, "updated_at": "2025-08-28T19:35:38.943", "approved_at": null, "approved_by": null, "is_approved": true, "national_id": null, "password_hash": null, "alternate_phone": null, "emergency_contact_name": null, "emergency_contact_phone": null}	\N	\N	\N	\N	2025-08-28 19:35:38.961958+00	\N
85	units	UPDATE	{"id": "41617cbe-0e5d-4341-a2b0-c03f977c14a2", "status": "vacant", "bedrooms": 2, "tax_rate": null, "bathrooms": 1.0, "unit_size": null, "created_at": "2025-08-27T15:51:13.893333", "deleted_at": null, "deleted_by": null, "is_deleted": false, "updated_at": "2025-08-27T15:51:13.893333", "description": "Two bedroom with modern kitchen and backup power", "property_id": "e6248e10-7d91-4f2c-8202-a3516c554478", "square_feet": 650, "unit_number": "EP17", "monthly_rent": 35000.00, "security_deposit": 35000.00}	{"id": "41617cbe-0e5d-4341-a2b0-c03f977c14a2", "status": "occupied", "bedrooms": 2, "tax_rate": null, "bathrooms": 1.0, "unit_size": null, "created_at": "2025-08-27T15:51:13.893333", "deleted_at": null, "deleted_by": null, "is_deleted": false, "updated_at": "2025-08-27T15:51:13.893333", "description": "Two bedroom with modern kitchen and backup power", "property_id": "e6248e10-7d91-4f2c-8202-a3516c554478", "square_feet": 650, "unit_number": "EP17", "monthly_rent": 35000.00, "security_deposit": 35000.00}	\N	\N	\N	\N	2025-08-28 19:37:11.645354+00	\N
86	users	UPDATE	{"id": "e5936f37-2444-47c2-a6e0-0d91653f4778", "role": "tenant", "email": "test3@example.com", "phone": "123456789", "kra_pin": null, "username": null, "is_active": true, "last_name": "User", "replit_id": null, "created_at": "2025-08-27T15:30:43.14318", "deleted_at": null, "deleted_by": null, "first_name": "Test", "is_deleted": false, "updated_at": "2025-08-27T15:30:43.14318", "approved_at": null, "approved_by": null, "is_approved": false, "national_id": null, "password_hash": null, "alternate_phone": null, "emergency_contact_name": null, "emergency_contact_phone": null}	{"id": "e5936f37-2444-47c2-a6e0-0d91653f4778", "role": "tenant", "email": "test3@example.com", "phone": "123456789", "kra_pin": null, "username": null, "is_active": true, "last_name": "User", "replit_id": null, "created_at": "2025-08-27T15:30:43.14318", "deleted_at": null, "deleted_by": null, "first_name": "Test", "is_deleted": false, "updated_at": "2025-08-28T19:37:11.67", "approved_at": null, "approved_by": null, "is_approved": true, "national_id": null, "password_hash": null, "alternate_phone": null, "emergency_contact_name": null, "emergency_contact_phone": null}	\N	\N	\N	\N	2025-08-28 19:37:11.688266+00	\N
87	leases	INSERT	\N	{"id": "29558fc6-0b66-41cd-9861-9e6cc34cea6e", "terms": null, "status": "active", "unit_id": "e4945474-4df8-46e6-a377-08391ba7b16a", "end_date": "2026-08-28T00:00:00", "tenant_id": "e8684c18-858f-4271-a1c6-9d622b77c471", "created_at": "2025-08-28T19:37:17.285455", "deleted_at": null, "deleted_by": null, "is_deleted": false, "start_date": "2025-08-28T00:00:00", "updated_at": "2025-08-28T19:37:17.285455", "monthly_rent": 20000.00, "move_in_date": "2025-08-28T00:00:00", "move_out_date": null, "move_out_reason": null, "security_deposit": 20000.00, "move_out_notice_date": null}	\N	\N	\N	\N	2025-08-28 19:37:17.285455+00	\N
88	units	UPDATE	{"id": "e4945474-4df8-46e6-a377-08391ba7b16a", "status": "vacant", "bedrooms": 2, "tax_rate": null, "bathrooms": 1.0, "unit_size": null, "created_at": "2025-08-27T15:51:13.893333", "deleted_at": null, "deleted_by": null, "is_deleted": false, "updated_at": "2025-08-27T15:51:13.893333", "description": "Two bedroom with modern kitchen and backup power", "property_id": "e6248e10-7d91-4f2c-8202-a3516c554478", "square_feet": 650, "unit_number": "EP20", "monthly_rent": 35000.00, "security_deposit": 35000.00}	{"id": "e4945474-4df8-46e6-a377-08391ba7b16a", "status": "occupied", "bedrooms": 2, "tax_rate": null, "bathrooms": 1.0, "unit_size": null, "created_at": "2025-08-27T15:51:13.893333", "deleted_at": null, "deleted_by": null, "is_deleted": false, "updated_at": "2025-08-27T15:51:13.893333", "description": "Two bedroom with modern kitchen and backup power", "property_id": "e6248e10-7d91-4f2c-8202-a3516c554478", "square_feet": 650, "unit_number": "EP20", "monthly_rent": 35000.00, "security_deposit": 35000.00}	\N	\N	\N	\N	2025-08-28 19:37:17.323241+00	\N
89	users	UPDATE	{"id": "e8684c18-858f-4271-a1c6-9d622b77c471", "role": "tenant", "email": "peter.mungai@yahoo.com", "phone": "+254723456789", "kra_pin": null, "username": null, "is_active": true, "last_name": "Mungai", "replit_id": null, "created_at": "2025-08-27T15:52:20.318571", "deleted_at": null, "deleted_by": null, "first_name": "Peter", "is_deleted": false, "updated_at": "2025-08-27T15:52:20.318571", "approved_at": null, "approved_by": null, "is_approved": false, "national_id": null, "password_hash": null, "alternate_phone": null, "emergency_contact_name": null, "emergency_contact_phone": null}	{"id": "e8684c18-858f-4271-a1c6-9d622b77c471", "role": "tenant", "email": "peter.mungai@yahoo.com", "phone": "+254723456789", "kra_pin": null, "username": null, "is_active": true, "last_name": "Mungai", "replit_id": null, "created_at": "2025-08-27T15:52:20.318571", "deleted_at": null, "deleted_by": null, "first_name": "Peter", "is_deleted": false, "updated_at": "2025-08-28T19:37:17.341", "approved_at": null, "approved_by": null, "is_approved": true, "national_id": null, "password_hash": null, "alternate_phone": null, "emergency_contact_name": null, "emergency_contact_phone": null}	\N	\N	\N	\N	2025-08-28 19:37:17.360861+00	\N
90	leases	INSERT	\N	{"id": "cb445980-5f31-4210-8835-f620c9069cd5", "terms": null, "status": "active", "unit_id": "d15ecbd7-4f65-472e-9d8d-b12cd3797ec0", "end_date": "2026-08-28T00:00:00", "tenant_id": "e8684c18-858f-4271-a1c6-9d622b77c471", "created_at": "2025-08-28T19:37:32.27546", "deleted_at": null, "deleted_by": null, "is_deleted": false, "start_date": "2025-08-28T00:00:00", "updated_at": "2025-08-28T19:37:32.27546", "monthly_rent": 20000.00, "move_in_date": "2025-08-28T00:00:00", "move_out_date": null, "move_out_reason": null, "security_deposit": 20000.00, "move_out_notice_date": null}	\N	\N	\N	\N	2025-08-28 19:37:32.27546+00	\N
91	units	UPDATE	{"id": "d15ecbd7-4f65-472e-9d8d-b12cd3797ec0", "status": "vacant", "bedrooms": 1, "tax_rate": null, "bathrooms": 1.0, "unit_size": null, "created_at": "2025-08-27T15:51:13.893333", "deleted_at": null, "deleted_by": null, "is_deleted": false, "updated_at": "2025-08-27T15:51:13.893333", "description": "One bedroom apartment near town center with parking", "property_id": "e6248e10-7d91-4f2c-8202-a3516c554478", "square_feet": 480, "unit_number": "EP19", "monthly_rent": 25000.00, "security_deposit": 25000.00}	{"id": "d15ecbd7-4f65-472e-9d8d-b12cd3797ec0", "status": "occupied", "bedrooms": 1, "tax_rate": null, "bathrooms": 1.0, "unit_size": null, "created_at": "2025-08-27T15:51:13.893333", "deleted_at": null, "deleted_by": null, "is_deleted": false, "updated_at": "2025-08-27T15:51:13.893333", "description": "One bedroom apartment near town center with parking", "property_id": "e6248e10-7d91-4f2c-8202-a3516c554478", "square_feet": 480, "unit_number": "EP19", "monthly_rent": 25000.00, "security_deposit": 25000.00}	\N	\N	\N	\N	2025-08-28 19:37:32.320188+00	\N
92	users	UPDATE	{"id": "e8684c18-858f-4271-a1c6-9d622b77c471", "role": "tenant", "email": "peter.mungai@yahoo.com", "phone": "+254723456789", "kra_pin": null, "username": null, "is_active": true, "last_name": "Mungai", "replit_id": null, "created_at": "2025-08-27T15:52:20.318571", "deleted_at": null, "deleted_by": null, "first_name": "Peter", "is_deleted": false, "updated_at": "2025-08-28T19:37:17.341", "approved_at": null, "approved_by": null, "is_approved": true, "national_id": null, "password_hash": null, "alternate_phone": null, "emergency_contact_name": null, "emergency_contact_phone": null}	{"id": "e8684c18-858f-4271-a1c6-9d622b77c471", "role": "tenant", "email": "peter.mungai@yahoo.com", "phone": "+254723456789", "kra_pin": null, "username": null, "is_active": true, "last_name": "Mungai", "replit_id": null, "created_at": "2025-08-27T15:52:20.318571", "deleted_at": null, "deleted_by": null, "first_name": "Peter", "is_deleted": false, "updated_at": "2025-08-28T19:37:32.339", "approved_at": null, "approved_by": null, "is_approved": true, "national_id": null, "password_hash": null, "alternate_phone": null, "emergency_contact_name": null, "emergency_contact_phone": null}	\N	\N	\N	\N	2025-08-28 19:37:32.357255+00	\N
93	leases	INSERT	\N	{"id": "424d357c-ba6f-4312-8527-52973cf0d804", "terms": null, "status": "active", "unit_id": "d15ecbd7-4f65-472e-9d8d-b12cd3797ec0", "end_date": "2026-08-28T00:00:00", "tenant_id": "aca97846-a7d3-413d-ad79-05336a6cf855", "created_at": "2025-08-28T19:37:36.114942", "deleted_at": null, "deleted_by": null, "is_deleted": false, "start_date": "2025-08-28T00:00:00", "updated_at": "2025-08-28T19:37:36.114942", "monthly_rent": 20000.00, "move_in_date": "2025-08-28T00:00:00", "move_out_date": null, "move_out_reason": null, "security_deposit": 20000.00, "move_out_notice_date": null}	\N	\N	\N	\N	2025-08-28 19:37:36.114942+00	\N
94	units	UPDATE	{"id": "d15ecbd7-4f65-472e-9d8d-b12cd3797ec0", "status": "occupied", "bedrooms": 1, "tax_rate": null, "bathrooms": 1.0, "unit_size": null, "created_at": "2025-08-27T15:51:13.893333", "deleted_at": null, "deleted_by": null, "is_deleted": false, "updated_at": "2025-08-27T15:51:13.893333", "description": "One bedroom apartment near town center with parking", "property_id": "e6248e10-7d91-4f2c-8202-a3516c554478", "square_feet": 480, "unit_number": "EP19", "monthly_rent": 25000.00, "security_deposit": 25000.00}	{"id": "d15ecbd7-4f65-472e-9d8d-b12cd3797ec0", "status": "occupied", "bedrooms": 1, "tax_rate": null, "bathrooms": 1.0, "unit_size": null, "created_at": "2025-08-27T15:51:13.893333", "deleted_at": null, "deleted_by": null, "is_deleted": false, "updated_at": "2025-08-27T15:51:13.893333", "description": "One bedroom apartment near town center with parking", "property_id": "e6248e10-7d91-4f2c-8202-a3516c554478", "square_feet": 480, "unit_number": "EP19", "monthly_rent": 25000.00, "security_deposit": 25000.00}	\N	\N	\N	\N	2025-08-28 19:37:36.152401+00	\N
95	users	UPDATE	{"id": "aca97846-a7d3-413d-ad79-05336a6cf855", "role": "tenant", "email": "admin@school.co.ke", "phone": "2345675", "kra_pin": null, "username": null, "is_active": true, "last_name": "Achieng", "replit_id": null, "created_at": "2025-08-27T15:26:29.406902", "deleted_at": null, "deleted_by": null, "first_name": "Kwame", "is_deleted": false, "updated_at": "2025-08-28T18:04:06.577", "approved_at": null, "approved_by": null, "is_approved": true, "national_id": null, "password_hash": null, "alternate_phone": null, "emergency_contact_name": null, "emergency_contact_phone": null}	{"id": "aca97846-a7d3-413d-ad79-05336a6cf855", "role": "tenant", "email": "admin@school.co.ke", "phone": "2345675", "kra_pin": null, "username": null, "is_active": true, "last_name": "Achieng", "replit_id": null, "created_at": "2025-08-27T15:26:29.406902", "deleted_at": null, "deleted_by": null, "first_name": "Kwame", "is_deleted": false, "updated_at": "2025-08-28T19:37:36.171", "approved_at": null, "approved_by": null, "is_approved": true, "national_id": null, "password_hash": null, "alternate_phone": null, "emergency_contact_name": null, "emergency_contact_phone": null}	\N	\N	\N	\N	2025-08-28 19:37:36.189768+00	\N
96	properties	DELETE	{"id": "912aa8d9-65dd-45a4-b41e-2a492dcf5970", "city": "Nairobi", "name": "QA Test Property UPDATED", "type": "apartment_complex", "state": "Nairobi", "status": "active", "address": "123 Test Street", "owner_id": null, "tax_rate": 7.50, "zip_code": null, "created_at": "2025-08-28T17:30:24.408226", "deleted_at": null, "deleted_by": null, "is_deleted": false, "manager_id": null, "mpesa_type": null, "updated_at": "2025-08-28T17:30:24.408226", "water_rate": null, "description": null, "total_units": 5, "purchase_date": null, "purchase_price": null, "electricity_rate": null, "mpesa_till_number": null, "rent_penalty_type": null, "mpesa_store_number": null, "management_fee_type": null, "rent_penalty_amount": null, "mpesa_account_number": null, "mpesa_paybill_number": null, "management_fee_amount": null}	\N	\N	\N	\N	\N	2025-08-28 19:46:47.660567+00	\N
97	properties	DELETE	{"id": "8b1d5f3e-eeaf-4610-b852-6d2e30c8fb8c", "city": "Ruiru", "name": "juiko", "type": "apartment_complex", "state": "Kiambu", "status": "active", "address": "K9678", "owner_id": null, "tax_rate": 7.50, "zip_code": null, "created_at": "2025-08-27T15:32:35.312242", "deleted_at": null, "deleted_by": null, "is_deleted": false, "manager_id": null, "mpesa_type": null, "updated_at": "2025-08-27T15:32:35.312242", "water_rate": null, "description": "", "total_units": 15, "purchase_date": null, "purchase_price": null, "electricity_rate": null, "mpesa_till_number": null, "rent_penalty_type": null, "mpesa_store_number": null, "management_fee_type": null, "rent_penalty_amount": null, "mpesa_account_number": null, "mpesa_paybill_number": null, "management_fee_amount": null}	\N	\N	\N	\N	\N	2025-08-28 19:46:59.203925+00	\N
98	leases	UPDATE	{"id": "6a94df84-620a-480a-8bf2-3d5e51141c66", "terms": null, "status": "active", "unit_id": "f344f75e-6f7e-401a-9a27-b3d3085f9f87", "end_date": null, "tenant_id": "0e434f88-0240-42c1-8546-bbe1f709148d", "created_at": "2025-08-28T14:49:18.818056", "deleted_at": null, "deleted_by": null, "is_deleted": false, "start_date": "2025-03-01T00:00:00", "updated_at": "2025-08-28T14:49:18.818056", "monthly_rent": 25000.00, "move_in_date": "2025-08-28T14:49:18.797", "move_out_date": null, "move_out_reason": null, "security_deposit": 25000.00, "move_out_notice_date": null}	{"id": "6a94df84-620a-480a-8bf2-3d5e51141c66", "terms": null, "status": "terminated", "unit_id": "f344f75e-6f7e-401a-9a27-b3d3085f9f87", "end_date": "2025-08-28T19:51:23.382", "tenant_id": "0e434f88-0240-42c1-8546-bbe1f709148d", "created_at": "2025-08-28T14:49:18.818056", "deleted_at": null, "deleted_by": null, "is_deleted": false, "start_date": "2025-03-01T00:00:00", "updated_at": "2025-08-28T19:51:23.382", "monthly_rent": 25000.00, "move_in_date": "2025-08-28T14:49:18.797", "move_out_date": null, "move_out_reason": null, "security_deposit": 25000.00, "move_out_notice_date": null}	\N	\N	\N	\N	2025-08-28 19:51:23.40094+00	\N
108	leases	DELETE	{"id": "c6225d77-31ce-42ae-b1fc-5d9613edf3df", "terms": null, "status": "terminated", "unit_id": "c0e705e1-bfb3-40e7-ab60-653610303e58", "end_date": "2025-08-28T19:53:26.945", "tenant_id": "9975884a-6ff5-4bdd-b05d-822b00dac43d", "created_at": "2025-08-28T17:53:50.660987", "deleted_at": null, "deleted_by": null, "is_deleted": false, "start_date": "2025-08-28T00:00:00", "updated_at": "2025-08-28T19:53:26.945", "monthly_rent": 20000.00, "move_in_date": "2025-08-28T00:00:00", "move_out_date": null, "move_out_reason": null, "security_deposit": 20000.00, "move_out_notice_date": null}	\N	\N	\N	\N	\N	2025-08-28 19:53:27.07793+00	\N
99	leases	UPDATE	{"id": "9419bd2a-d2fc-4b52-8d01-7b0b099125f0", "terms": null, "status": "active", "unit_id": "f344f75e-6f7e-401a-9a27-b3d3085f9f87", "end_date": "2025-12-31T00:00:00", "tenant_id": "a35934b4-b108-4be9-894a-967c257a8da9", "created_at": "2025-08-28T17:53:21.587376", "deleted_at": null, "deleted_by": null, "is_deleted": false, "start_date": "2025-01-01T00:00:00", "updated_at": "2025-08-28T17:53:21.587376", "monthly_rent": 18000.00, "move_in_date": "2025-01-01T00:00:00", "move_out_date": null, "move_out_reason": null, "security_deposit": 18000.00, "move_out_notice_date": null}	{"id": "9419bd2a-d2fc-4b52-8d01-7b0b099125f0", "terms": null, "status": "terminated", "unit_id": "f344f75e-6f7e-401a-9a27-b3d3085f9f87", "end_date": "2025-08-28T19:51:23.382", "tenant_id": "a35934b4-b108-4be9-894a-967c257a8da9", "created_at": "2025-08-28T17:53:21.587376", "deleted_at": null, "deleted_by": null, "is_deleted": false, "start_date": "2025-01-01T00:00:00", "updated_at": "2025-08-28T19:51:23.382", "monthly_rent": 18000.00, "move_in_date": "2025-01-01T00:00:00", "move_out_date": null, "move_out_reason": null, "security_deposit": 18000.00, "move_out_notice_date": null}	\N	\N	\N	\N	2025-08-28 19:51:23.40094+00	\N
100	leases	DELETE	{"id": "66fe9857-afc0-4ecf-ab25-5956c2dfabc1", "terms": null, "status": "pending", "unit_id": "f344f75e-6f7e-401a-9a27-b3d3085f9f87", "end_date": "2025-12-31T00:00:00", "tenant_id": "524633e8-667b-4a00-9346-25c7fe8e3e54", "created_at": "2025-08-28T17:53:02.509144", "deleted_at": null, "deleted_by": null, "is_deleted": false, "start_date": "2025-01-01T00:00:00", "updated_at": "2025-08-28T17:53:02.509144", "monthly_rent": 25000.00, "move_in_date": "2025-01-01T00:00:00", "move_out_date": null, "move_out_reason": null, "security_deposit": 25000.00, "move_out_notice_date": null}	\N	\N	\N	\N	\N	2025-08-28 19:51:23.548009+00	\N
101	leases	DELETE	{"id": "6a94df84-620a-480a-8bf2-3d5e51141c66", "terms": null, "status": "terminated", "unit_id": "f344f75e-6f7e-401a-9a27-b3d3085f9f87", "end_date": "2025-08-28T19:51:23.382", "tenant_id": "0e434f88-0240-42c1-8546-bbe1f709148d", "created_at": "2025-08-28T14:49:18.818056", "deleted_at": null, "deleted_by": null, "is_deleted": false, "start_date": "2025-03-01T00:00:00", "updated_at": "2025-08-28T19:51:23.382", "monthly_rent": 25000.00, "move_in_date": "2025-08-28T14:49:18.797", "move_out_date": null, "move_out_reason": null, "security_deposit": 25000.00, "move_out_notice_date": null}	\N	\N	\N	\N	\N	2025-08-28 19:51:23.548009+00	\N
102	leases	DELETE	{"id": "9419bd2a-d2fc-4b52-8d01-7b0b099125f0", "terms": null, "status": "terminated", "unit_id": "f344f75e-6f7e-401a-9a27-b3d3085f9f87", "end_date": "2025-08-28T19:51:23.382", "tenant_id": "a35934b4-b108-4be9-894a-967c257a8da9", "created_at": "2025-08-28T17:53:21.587376", "deleted_at": null, "deleted_by": null, "is_deleted": false, "start_date": "2025-01-01T00:00:00", "updated_at": "2025-08-28T19:51:23.382", "monthly_rent": 18000.00, "move_in_date": "2025-01-01T00:00:00", "move_out_date": null, "move_out_reason": null, "security_deposit": 18000.00, "move_out_notice_date": null}	\N	\N	\N	\N	\N	2025-08-28 19:51:23.548009+00	\N
103	units	DELETE	{"id": "f344f75e-6f7e-401a-9a27-b3d3085f9f87", "status": "occupied", "bedrooms": 1, "tax_rate": null, "bathrooms": 1.0, "unit_size": null, "created_at": "2025-08-27T15:51:13.893333", "deleted_at": null, "deleted_by": null, "is_deleted": false, "updated_at": "2025-08-28T14:49:18.916", "description": "One bedroom apartment near town center with parking", "property_id": "e6248e10-7d91-4f2c-8202-a3516c554478", "square_feet": 480, "unit_number": "EP1", "monthly_rent": 25000.00, "security_deposit": 25000.00}	\N	\N	\N	\N	\N	2025-08-28 19:51:23.588359+00	\N
104	leases	UPDATE	{"id": "40b95490-f848-471f-907c-cdc32a82fc39", "terms": "Studio apartment with modern amenities. Perfect for working professional. Internet included.", "status": "active", "unit_id": "27d38268-1b36-4e79-9520-b3b4a4a5730b", "end_date": "2025-03-31T00:00:00", "tenant_id": "6e7e3832-a88b-40e9-8a10-639edcd5c0f5", "created_at": "2025-08-27T15:54:04.636259", "deleted_at": null, "deleted_by": null, "is_deleted": false, "start_date": "2024-04-01T00:00:00", "updated_at": "2025-08-27T15:54:04.636259", "monthly_rent": 65000.00, "move_in_date": null, "move_out_date": null, "move_out_reason": null, "security_deposit": 65000.00, "move_out_notice_date": null}	{"id": "40b95490-f848-471f-907c-cdc32a82fc39", "terms": "Studio apartment with modern amenities. Perfect for working professional. Internet included.", "status": "terminated", "unit_id": "27d38268-1b36-4e79-9520-b3b4a4a5730b", "end_date": "2025-08-28T19:51:34.568", "tenant_id": "6e7e3832-a88b-40e9-8a10-639edcd5c0f5", "created_at": "2025-08-27T15:54:04.636259", "deleted_at": null, "deleted_by": null, "is_deleted": false, "start_date": "2024-04-01T00:00:00", "updated_at": "2025-08-28T19:51:34.568", "monthly_rent": 65000.00, "move_in_date": null, "move_out_date": null, "move_out_reason": null, "security_deposit": 65000.00, "move_out_notice_date": null}	\N	\N	\N	\N	2025-08-28 19:51:34.585935+00	\N
105	leases	DELETE	{"id": "40b95490-f848-471f-907c-cdc32a82fc39", "terms": "Studio apartment with modern amenities. Perfect for working professional. Internet included.", "status": "terminated", "unit_id": "27d38268-1b36-4e79-9520-b3b4a4a5730b", "end_date": "2025-08-28T19:51:34.568", "tenant_id": "6e7e3832-a88b-40e9-8a10-639edcd5c0f5", "created_at": "2025-08-27T15:54:04.636259", "deleted_at": null, "deleted_by": null, "is_deleted": false, "start_date": "2024-04-01T00:00:00", "updated_at": "2025-08-28T19:51:34.568", "monthly_rent": 65000.00, "move_in_date": null, "move_out_date": null, "move_out_reason": null, "security_deposit": 65000.00, "move_out_notice_date": null}	\N	\N	\N	\N	\N	2025-08-28 19:52:14.034447+00	\N
106	users	DELETE	{"id": "6e7e3832-a88b-40e9-8a10-639edcd5c0f5", "role": "tenant", "email": "achieng.ochieng@gmail.com", "phone": "+254756789012", "kra_pin": null, "username": null, "is_active": true, "last_name": "Ochieng", "replit_id": null, "created_at": "2025-08-27T15:52:20.318571", "deleted_at": null, "deleted_by": null, "first_name": "Achieng", "is_deleted": false, "updated_at": "2025-08-27T15:52:20.318571", "approved_at": null, "approved_by": null, "is_approved": false, "national_id": null, "password_hash": null, "alternate_phone": null, "emergency_contact_name": null, "emergency_contact_phone": null}	\N	\N	\N	\N	\N	2025-08-28 19:52:14.07315+00	\N
107	leases	UPDATE	{"id": "c6225d77-31ce-42ae-b1fc-5d9613edf3df", "terms": null, "status": "active", "unit_id": "c0e705e1-bfb3-40e7-ab60-653610303e58", "end_date": "2026-08-28T00:00:00", "tenant_id": "9975884a-6ff5-4bdd-b05d-822b00dac43d", "created_at": "2025-08-28T17:53:50.660987", "deleted_at": null, "deleted_by": null, "is_deleted": false, "start_date": "2025-08-28T00:00:00", "updated_at": "2025-08-28T17:53:50.660987", "monthly_rent": 20000.00, "move_in_date": "2025-08-28T00:00:00", "move_out_date": null, "move_out_reason": null, "security_deposit": 20000.00, "move_out_notice_date": null}	{"id": "c6225d77-31ce-42ae-b1fc-5d9613edf3df", "terms": null, "status": "terminated", "unit_id": "c0e705e1-bfb3-40e7-ab60-653610303e58", "end_date": "2025-08-28T19:53:26.945", "tenant_id": "9975884a-6ff5-4bdd-b05d-822b00dac43d", "created_at": "2025-08-28T17:53:50.660987", "deleted_at": null, "deleted_by": null, "is_deleted": false, "start_date": "2025-08-28T00:00:00", "updated_at": "2025-08-28T19:53:26.945", "monthly_rent": 20000.00, "move_in_date": "2025-08-28T00:00:00", "move_out_date": null, "move_out_reason": null, "security_deposit": 20000.00, "move_out_notice_date": null}	\N	\N	\N	\N	2025-08-28 19:53:26.964945+00	\N
109	units	DELETE	{"id": "c0e705e1-bfb3-40e7-ab60-653610303e58", "status": "occupied", "bedrooms": 1, "tax_rate": null, "bathrooms": 1.0, "unit_size": null, "created_at": "2025-08-27T15:51:13.893333", "deleted_at": null, "deleted_by": null, "is_deleted": false, "updated_at": "2025-08-27T15:51:13.893333", "description": "One bedroom apartment near town center with parking", "property_id": "e6248e10-7d91-4f2c-8202-a3516c554478", "square_feet": 480, "unit_number": "EP10", "monthly_rent": 25000.00, "security_deposit": 25000.00}	\N	\N	\N	\N	\N	2025-08-28 19:53:27.121602+00	\N
110	leases	UPDATE	{"id": "07d98fb5-4090-4ae7-9d35-5c7791d4a25c", "terms": null, "status": "active", "unit_id": "313a491b-9644-478d-8860-97b184c9da8c", "end_date": "2026-08-28T00:00:00", "tenant_id": "aca97846-a7d3-413d-ad79-05336a6cf855", "created_at": "2025-08-28T18:04:06.519756", "deleted_at": null, "deleted_by": null, "is_deleted": false, "start_date": "2025-08-28T00:00:00", "updated_at": "2025-08-28T18:04:06.519756", "monthly_rent": 20000.00, "move_in_date": "2025-08-28T00:00:00", "move_out_date": null, "move_out_reason": null, "security_deposit": 20000.00, "move_out_notice_date": null}	{"id": "07d98fb5-4090-4ae7-9d35-5c7791d4a25c", "terms": null, "status": "terminated", "unit_id": "313a491b-9644-478d-8860-97b184c9da8c", "end_date": "2025-08-28T19:53:36.498", "tenant_id": "aca97846-a7d3-413d-ad79-05336a6cf855", "created_at": "2025-08-28T18:04:06.519756", "deleted_at": null, "deleted_by": null, "is_deleted": false, "start_date": "2025-08-28T00:00:00", "updated_at": "2025-08-28T19:53:36.498", "monthly_rent": 20000.00, "move_in_date": "2025-08-28T00:00:00", "move_out_date": null, "move_out_reason": null, "security_deposit": 20000.00, "move_out_notice_date": null}	\N	\N	\N	\N	2025-08-28 19:53:36.516515+00	\N
111	leases	DELETE	{"id": "07d98fb5-4090-4ae7-9d35-5c7791d4a25c", "terms": null, "status": "terminated", "unit_id": "313a491b-9644-478d-8860-97b184c9da8c", "end_date": "2025-08-28T19:53:36.498", "tenant_id": "aca97846-a7d3-413d-ad79-05336a6cf855", "created_at": "2025-08-28T18:04:06.519756", "deleted_at": null, "deleted_by": null, "is_deleted": false, "start_date": "2025-08-28T00:00:00", "updated_at": "2025-08-28T19:53:36.498", "monthly_rent": 20000.00, "move_in_date": "2025-08-28T00:00:00", "move_out_date": null, "move_out_reason": null, "security_deposit": 20000.00, "move_out_notice_date": null}	\N	\N	\N	\N	\N	2025-08-28 19:53:36.624997+00	\N
112	units	DELETE	{"id": "313a491b-9644-478d-8860-97b184c9da8c", "status": "occupied", "bedrooms": 2, "tax_rate": null, "bathrooms": 1.0, "unit_size": null, "created_at": "2025-08-27T15:51:13.893333", "deleted_at": null, "deleted_by": null, "is_deleted": false, "updated_at": "2025-08-27T15:51:13.893333", "description": "Two bedroom with modern kitchen and backup power", "property_id": "e6248e10-7d91-4f2c-8202-a3516c554478", "square_feet": 650, "unit_number": "EP11", "monthly_rent": 35000.00, "security_deposit": 35000.00}	\N	\N	\N	\N	\N	2025-08-28 19:53:36.661207+00	\N
113	leases	UPDATE	{"id": "313ba910-6da1-49b9-ab95-7f854ecf3270", "terms": null, "status": "active", "unit_id": "6d243dca-f7e5-4608-93b6-03fd5cabdc38", "end_date": "2026-08-28T00:00:00", "tenant_id": "8c6c5d2a-c1c8-4cd6-a973-2e6b2f2e6246", "created_at": "2025-08-28T18:04:00.447777", "deleted_at": null, "deleted_by": null, "is_deleted": false, "start_date": "2025-08-28T00:00:00", "updated_at": "2025-08-28T18:04:00.447777", "monthly_rent": 20000.00, "move_in_date": "2025-08-28T00:00:00", "move_out_date": null, "move_out_reason": null, "security_deposit": 20000.00, "move_out_notice_date": null}	{"id": "313ba910-6da1-49b9-ab95-7f854ecf3270", "terms": null, "status": "terminated", "unit_id": "6d243dca-f7e5-4608-93b6-03fd5cabdc38", "end_date": "2025-08-28T20:05:38.342", "tenant_id": "8c6c5d2a-c1c8-4cd6-a973-2e6b2f2e6246", "created_at": "2025-08-28T18:04:00.447777", "deleted_at": null, "deleted_by": null, "is_deleted": false, "start_date": "2025-08-28T00:00:00", "updated_at": "2025-08-28T20:05:38.342", "monthly_rent": 20000.00, "move_in_date": "2025-08-28T00:00:00", "move_out_date": null, "move_out_reason": null, "security_deposit": 20000.00, "move_out_notice_date": null}	\N	\N	\N	\N	2025-08-28 20:05:38.360203+00	\N
114	leases	DELETE	{"id": "313ba910-6da1-49b9-ab95-7f854ecf3270", "terms": null, "status": "terminated", "unit_id": "6d243dca-f7e5-4608-93b6-03fd5cabdc38", "end_date": "2025-08-28T20:05:38.342", "tenant_id": "8c6c5d2a-c1c8-4cd6-a973-2e6b2f2e6246", "created_at": "2025-08-28T18:04:00.447777", "deleted_at": null, "deleted_by": null, "is_deleted": false, "start_date": "2025-08-28T00:00:00", "updated_at": "2025-08-28T20:05:38.342", "monthly_rent": 20000.00, "move_in_date": "2025-08-28T00:00:00", "move_out_date": null, "move_out_reason": null, "security_deposit": 20000.00, "move_out_notice_date": null}	\N	\N	\N	\N	\N	2025-08-28 20:05:38.554067+00	\N
115	units	DELETE	{"id": "6d243dca-f7e5-4608-93b6-03fd5cabdc38", "status": "occupied", "bedrooms": 1, "tax_rate": null, "bathrooms": 1.0, "unit_size": null, "created_at": "2025-08-27T15:51:13.893333", "deleted_at": null, "deleted_by": null, "is_deleted": false, "updated_at": "2025-08-27T15:51:13.893333", "description": "One bedroom apartment near town center with parking", "property_id": "e6248e10-7d91-4f2c-8202-a3516c554478", "square_feet": 480, "unit_number": "EP13", "monthly_rent": 25000.00, "security_deposit": 25000.00}	\N	\N	\N	\N	\N	2025-08-28 20:05:38.594772+00	\N
116	leases	INSERT	\N	{"id": "749892d8-bafa-45e4-8f27-66708a5abbea", "terms": null, "status": "active", "unit_id": "a9190f9f-e49a-423e-b798-ee5fba88cadf", "end_date": "2026-08-28T00:00:00", "tenant_id": "007468de-0ba0-4014-953a-0b0e2ebe091e", "created_at": "2025-08-28T20:06:01.769673", "deleted_at": null, "deleted_by": null, "is_deleted": false, "start_date": "2025-08-28T00:00:00", "updated_at": "2025-08-28T20:06:01.769673", "monthly_rent": 20000.00, "move_in_date": "2025-08-28T00:00:00", "move_out_date": null, "move_out_reason": null, "security_deposit": 20000.00, "move_out_notice_date": null}	\N	\N	\N	\N	2025-08-28 20:06:01.769673+00	\N
117	units	UPDATE	{"id": "a9190f9f-e49a-423e-b798-ee5fba88cadf", "status": "vacant", "bedrooms": 1, "tax_rate": null, "bathrooms": 1.0, "unit_size": null, "created_at": "2025-08-27T15:51:13.893333", "deleted_at": null, "deleted_by": null, "is_deleted": false, "updated_at": "2025-08-27T15:51:13.893333", "description": "One bedroom apartment near town center with parking", "property_id": "e6248e10-7d91-4f2c-8202-a3516c554478", "square_feet": 480, "unit_number": "EP16", "monthly_rent": 25000.00, "security_deposit": 25000.00}	{"id": "a9190f9f-e49a-423e-b798-ee5fba88cadf", "status": "occupied", "bedrooms": 1, "tax_rate": null, "bathrooms": 1.0, "unit_size": null, "created_at": "2025-08-27T15:51:13.893333", "deleted_at": null, "deleted_by": null, "is_deleted": false, "updated_at": "2025-08-27T15:51:13.893333", "description": "One bedroom apartment near town center with parking", "property_id": "e6248e10-7d91-4f2c-8202-a3516c554478", "square_feet": 480, "unit_number": "EP16", "monthly_rent": 25000.00, "security_deposit": 25000.00}	\N	\N	\N	\N	2025-08-28 20:06:01.810526+00	\N
118	users	UPDATE	{"id": "007468de-0ba0-4014-953a-0b0e2ebe091e", "role": "tenant", "email": "geltechke@gmail.com", "phone": null, "kra_pin": null, "username": null, "is_active": true, "last_name": "Andisi", "replit_id": "44061691", "created_at": "2025-08-27T15:01:19.738891", "deleted_at": null, "deleted_by": null, "first_name": "Agini", "is_deleted": false, "updated_at": "2025-08-27T16:00:03.454", "approved_at": null, "approved_by": null, "is_approved": false, "national_id": null, "password_hash": null, "alternate_phone": null, "emergency_contact_name": null, "emergency_contact_phone": null}	{"id": "007468de-0ba0-4014-953a-0b0e2ebe091e", "role": "tenant", "email": "geltechke@gmail.com", "phone": null, "kra_pin": null, "username": null, "is_active": true, "last_name": "Andisi", "replit_id": "44061691", "created_at": "2025-08-27T15:01:19.738891", "deleted_at": null, "deleted_by": null, "first_name": "Agini", "is_deleted": false, "updated_at": "2025-08-28T20:06:01.83", "approved_at": null, "approved_by": null, "is_approved": true, "national_id": null, "password_hash": null, "alternate_phone": null, "emergency_contact_name": null, "emergency_contact_phone": null}	\N	\N	\N	\N	2025-08-28 20:06:01.849274+00	\N
119	leases	INSERT	\N	{"id": "c42b0660-d6dd-4d4d-9597-ad2d32f629aa", "terms": null, "status": "active", "unit_id": "e2fa4f9c-3b1e-4cdf-bfec-980154078802", "end_date": "2026-08-28T00:00:00", "tenant_id": "3c462235-e652-463f-a89a-ffcf6693569a", "created_at": "2025-08-28T20:06:20.306992", "deleted_at": null, "deleted_by": null, "is_deleted": false, "start_date": "2025-08-28T00:00:00", "updated_at": "2025-08-28T20:06:20.306992", "monthly_rent": 20000.00, "move_in_date": "2025-08-28T00:00:00", "move_out_date": null, "move_out_reason": null, "security_deposit": 20000.00, "move_out_notice_date": null}	\N	\N	\N	\N	2025-08-28 20:06:20.306992+00	\N
120	units	UPDATE	{"id": "e2fa4f9c-3b1e-4cdf-bfec-980154078802", "status": "vacant", "bedrooms": 2, "tax_rate": null, "bathrooms": 1.0, "unit_size": null, "created_at": "2025-08-27T15:51:13.893333", "deleted_at": null, "deleted_by": null, "is_deleted": false, "updated_at": "2025-08-27T15:51:13.893333", "description": "Two bedroom with modern kitchen and backup power", "property_id": "e6248e10-7d91-4f2c-8202-a3516c554478", "square_feet": 650, "unit_number": "EP2", "monthly_rent": 35000.00, "security_deposit": 35000.00}	{"id": "e2fa4f9c-3b1e-4cdf-bfec-980154078802", "status": "occupied", "bedrooms": 2, "tax_rate": null, "bathrooms": 1.0, "unit_size": null, "created_at": "2025-08-27T15:51:13.893333", "deleted_at": null, "deleted_by": null, "is_deleted": false, "updated_at": "2025-08-27T15:51:13.893333", "description": "Two bedroom with modern kitchen and backup power", "property_id": "e6248e10-7d91-4f2c-8202-a3516c554478", "square_feet": 650, "unit_number": "EP2", "monthly_rent": 35000.00, "security_deposit": 35000.00}	\N	\N	\N	\N	2025-08-28 20:06:20.344368+00	\N
121	users	UPDATE	{"id": "3c462235-e652-463f-a89a-ffcf6693569a", "role": "tenant", "email": "agnes.mbatha@gmail.com", "phone": "+254790123478", "kra_pin": null, "username": null, "is_active": true, "last_name": "Mbatha", "replit_id": null, "created_at": "2025-08-27T15:52:20.318571", "deleted_at": null, "deleted_by": null, "first_name": "Agnes", "is_deleted": false, "updated_at": "2025-08-27T15:52:20.318571", "approved_at": null, "approved_by": null, "is_approved": false, "national_id": null, "password_hash": null, "alternate_phone": null, "emergency_contact_name": null, "emergency_contact_phone": null}	{"id": "3c462235-e652-463f-a89a-ffcf6693569a", "role": "tenant", "email": "agnes.mbatha@gmail.com", "phone": "+254790123478", "kra_pin": null, "username": null, "is_active": true, "last_name": "Mbatha", "replit_id": null, "created_at": "2025-08-27T15:52:20.318571", "deleted_at": null, "deleted_by": null, "first_name": "Agnes", "is_deleted": false, "updated_at": "2025-08-28T20:06:20.363", "approved_at": null, "approved_by": null, "is_approved": true, "national_id": null, "password_hash": null, "alternate_phone": null, "emergency_contact_name": null, "emergency_contact_phone": null}	\N	\N	\N	\N	2025-08-28 20:06:20.381704+00	\N
122	users	INSERT	\N	{"id": "81062927-0c65-48d2-9a57-b8c15e98c12c", "role": "tenant", "email": "clerk@school.com", "phone": "0702198791", "kra_pin": null, "username": null, "is_active": true, "last_name": "asiko", "replit_id": null, "created_at": "2025-08-28T20:07:25.773927", "deleted_at": null, "deleted_by": null, "first_name": "Pope", "is_deleted": false, "updated_at": "2025-08-28T20:07:25.773927", "approved_at": null, "approved_by": null, "is_approved": false, "national_id": null, "password_hash": null, "alternate_phone": null, "emergency_contact_name": null, "emergency_contact_phone": null}	\N	\N	\N	\N	2025-08-28 20:07:25.773927+00	\N
123	leases	INSERT	\N	{"id": "0a53ce7c-9379-4f07-9d58-7766bf7a4485", "terms": null, "status": "active", "unit_id": "810e3926-0639-4d4c-a8d6-99bf82198876", "end_date": "2026-08-28T00:00:00", "tenant_id": "d593f8db-085b-4830-9f4a-498c3b5ede78", "created_at": "2025-08-28T20:08:12.42081", "deleted_at": null, "deleted_by": null, "is_deleted": false, "start_date": "2025-08-28T00:00:00", "updated_at": "2025-08-28T20:08:12.42081", "monthly_rent": 20000.00, "move_in_date": "2025-08-28T00:00:00", "move_out_date": null, "move_out_reason": null, "security_deposit": 20000.00, "move_out_notice_date": null}	\N	\N	\N	\N	2025-08-28 20:08:12.42081+00	\N
124	units	UPDATE	{"id": "810e3926-0639-4d4c-a8d6-99bf82198876", "status": "vacant", "bedrooms": 2, "tax_rate": null, "bathrooms": 1.0, "unit_size": null, "created_at": "2025-08-27T15:51:13.893333", "deleted_at": null, "deleted_by": null, "is_deleted": false, "updated_at": "2025-08-27T15:51:13.893333", "description": "Two bedroom with modern kitchen and backup power", "property_id": "e6248e10-7d91-4f2c-8202-a3516c554478", "square_feet": 650, "unit_number": "EP23", "monthly_rent": 35000.00, "security_deposit": 35000.00}	{"id": "810e3926-0639-4d4c-a8d6-99bf82198876", "status": "occupied", "bedrooms": 2, "tax_rate": null, "bathrooms": 1.0, "unit_size": null, "created_at": "2025-08-27T15:51:13.893333", "deleted_at": null, "deleted_by": null, "is_deleted": false, "updated_at": "2025-08-27T15:51:13.893333", "description": "Two bedroom with modern kitchen and backup power", "property_id": "e6248e10-7d91-4f2c-8202-a3516c554478", "square_feet": 650, "unit_number": "EP23", "monthly_rent": 35000.00, "security_deposit": 35000.00}	\N	\N	\N	\N	2025-08-28 20:08:12.466034+00	\N
125	users	UPDATE	{"id": "d593f8db-085b-4830-9f4a-498c3b5ede78", "role": "tenant", "email": "hiyuo@hmcoo.com", "phone": null, "kra_pin": null, "username": null, "is_active": true, "last_name": "John", "replit_id": null, "created_at": "2025-08-28T12:33:15.791029", "deleted_at": null, "deleted_by": null, "first_name": "Pope", "is_deleted": false, "updated_at": "2025-08-28T12:33:15.791029", "approved_at": null, "approved_by": null, "is_approved": false, "national_id": null, "password_hash": null, "alternate_phone": null, "emergency_contact_name": null, "emergency_contact_phone": null}	{"id": "d593f8db-085b-4830-9f4a-498c3b5ede78", "role": "tenant", "email": "hiyuo@hmcoo.com", "phone": null, "kra_pin": null, "username": null, "is_active": true, "last_name": "John", "replit_id": null, "created_at": "2025-08-28T12:33:15.791029", "deleted_at": null, "deleted_by": null, "first_name": "Pope", "is_deleted": false, "updated_at": "2025-08-28T20:08:12.484", "approved_at": null, "approved_by": null, "is_approved": true, "national_id": null, "password_hash": null, "alternate_phone": null, "emergency_contact_name": null, "emergency_contact_phone": null}	\N	\N	\N	\N	2025-08-28 20:08:12.503342+00	\N
126	leases	UPDATE	{"id": "9d98a812-309c-4ba8-ba10-7625c6c541fe", "terms": "Three bedroom near market area. Good for business persons. Security deposit negotiable.", "status": "active", "unit_id": "0cca6cf6-04d1-433a-8d98-2f7ba8fa4354", "end_date": "2025-05-31T00:00:00", "tenant_id": "1384fd1f-75a5-409c-83ef-2106fe0878fc", "created_at": "2025-08-27T15:54:04.636259", "deleted_at": null, "deleted_by": null, "is_deleted": false, "start_date": "2024-06-01T00:00:00", "updated_at": "2025-08-27T15:54:04.636259", "monthly_rent": 50000.00, "move_in_date": null, "move_out_date": null, "move_out_reason": null, "security_deposit": 50000.00, "move_out_notice_date": null}	{"id": "9d98a812-309c-4ba8-ba10-7625c6c541fe", "terms": "Three bedroom near market area. Good for business persons. Security deposit negotiable.", "status": "terminated", "unit_id": "0cca6cf6-04d1-433a-8d98-2f7ba8fa4354", "end_date": "2025-08-28T20:16:24.43", "tenant_id": "1384fd1f-75a5-409c-83ef-2106fe0878fc", "created_at": "2025-08-27T15:54:04.636259", "deleted_at": null, "deleted_by": null, "is_deleted": false, "start_date": "2024-06-01T00:00:00", "updated_at": "2025-08-28T20:16:24.43", "monthly_rent": 50000.00, "move_in_date": null, "move_out_date": null, "move_out_reason": null, "security_deposit": 50000.00, "move_out_notice_date": null}	\N	\N	\N	\N	2025-08-28 20:16:24.44896+00	\N
127	leases	DELETE	{"id": "9d98a812-309c-4ba8-ba10-7625c6c541fe", "terms": "Three bedroom near market area. Good for business persons. Security deposit negotiable.", "status": "terminated", "unit_id": "0cca6cf6-04d1-433a-8d98-2f7ba8fa4354", "end_date": "2025-08-28T20:16:24.43", "tenant_id": "1384fd1f-75a5-409c-83ef-2106fe0878fc", "created_at": "2025-08-27T15:54:04.636259", "deleted_at": null, "deleted_by": null, "is_deleted": false, "start_date": "2024-06-01T00:00:00", "updated_at": "2025-08-28T20:16:24.43", "monthly_rent": 50000.00, "move_in_date": null, "move_out_date": null, "move_out_reason": null, "security_deposit": 50000.00, "move_out_notice_date": null}	\N	\N	\N	\N	\N	2025-08-28 20:16:24.597551+00	\N
128	units	DELETE	{"id": "0cca6cf6-04d1-433a-8d98-2f7ba8fa4354", "status": "occupied", "bedrooms": 3, "tax_rate": null, "bathrooms": 2.0, "unit_size": null, "created_at": "2025-08-27T15:51:13.893333", "deleted_at": null, "deleted_by": null, "is_deleted": false, "updated_at": "2025-08-27T15:51:13.893333", "description": "Three bedroom with master ensuite and city views", "property_id": "e6248e10-7d91-4f2c-8202-a3516c554478", "square_feet": 850, "unit_number": "EP12", "monthly_rent": 50000.00, "security_deposit": 50000.00}	\N	\N	\N	\N	\N	2025-08-28 20:16:24.637245+00	\N
129	units	DELETE	{"id": "4ec2507b-d25c-42ca-8646-21302e7434dc", "status": "vacant", "bedrooms": 1, "tax_rate": null, "bathrooms": 1.0, "unit_size": null, "created_at": "2025-08-27T15:51:13.893333", "deleted_at": null, "deleted_by": null, "is_deleted": false, "updated_at": "2025-08-27T15:51:13.893333", "description": "One bedroom apartment near town center with parking", "property_id": "e6248e10-7d91-4f2c-8202-a3516c554478", "square_feet": 480, "unit_number": "EP25", "monthly_rent": 25000.00, "security_deposit": 25000.00}	\N	\N	\N	\N	\N	2025-08-28 20:16:37.491232+00	\N
\.
...
COPY public.expenditures (id, property_id, category, amount, description, payment_date, recipient, payment_method, recurring, recurring_period, next_due_date, is_deleted, deleted_at, deleted_by, created_at, updated_at) FROM stdin;
7c04a39f-84e6-45d7-9ca4-922486303f02	\N	maintenance	5000.00	QA Test Expenditure	2025-08-28 00:00:00	QA Test Vendor	cash	f	\N	\N	f	\N	\N	2025-08-28 17:37:03.435355	2025-08-28 17:37:03.435355
4f90a0af-ce9e-4a5b-9b2c-bd250aed1911	\N	utilities	1200.00	Electricity Bill	2025-08-27 00:00:00	KPLC	bank_transfer	t	monthly	2025-09-27 00:00:00	f	\N	\N	2025-08-28 17:37:05.696401	2025-08-28 17:37:05.696401
\.
...
COPY public.idempotency_keys (id, key, created_at) FROM stdin;
\.
...
COPY public.invoices (id, tenant_id, unit_id, invoice_number, amount, due_date, status, description, items_json, created_at, updated_at, amount_due, amount_paid, period_month, period_year) FROM stdin;
\.
...
856de406-311d-44aa-ac89-d9ef72f701a9	3581ef01-5960-4ac4-9771-c27b093f1365	e32c34d0-86c6-47f9-950d-9b31f87a4aef	2025-08-28 17:24:11.07	\N	0.00	0.00	active	\N	2025-08-28 17:24:11.092342	2025-08-28 17:24:11.092342	2025-08-28 17:24:11.07	\N	\N	\N	f	\N	\N
454a6b1c-fa70-401f-b1ab-60e5a3b2f4e3	3581ef01-5960-4ac4-9771-c27b093f1365	60345685-88fb-4b28-8bdf-4a26314b80c6	2025-08-28 00:00:00	\N	30000.00	0.00	active	\N	2025-08-28 17:30:56.74792	2025-08-28 17:30:56.74792	2025-08-28 17:30:56.726	\N	\N	\N	f	\N	\N
01f9fb28-0b2b-4855-92fe-ba199c0d9673	579511fd-d630-4279-98aa-633a3223eec7	11ca1000-416a-4fe9-8561-f6bf6b204d90	2025-08-28 00:00:00	2026-08-28 00:00:00	20000.00	20000.00	active	\N	2025-08-28 19:35:38.874417	2025-08-28 19:35:38.874417	2025-08-28 00:00:00	\N	\N	\N	f	\N	\N
f0e1ebac-5ae4-41de-a63b-577ba92edbe4	41617cbe-0e5d-4341-a2b0-c03f977c14a2	e5936f37-2444-47c2-a6e0-0d91653f4778	2025-08-28 00:00:00	2026-08-28 00:00:00	20000.00	20000.00	active	\N	2025-08-28 19:37:11.498713	2025-08-28 19:37:11.498713	2025-08-28 00:00:00	\N	\N	\N	f	\N	\N
29558fc6-0b66-41cd-9861-9e6cc34cea6e	e4945474-4df8-46e6-a377-08391ba7b16a	e8684c18-858f-4271-a1c6-9d622b77c471	2025-08-28 00:00:00	2026-08-28 00:00:00	20000.00	20000.00	active	\N	2025-08-28 19:37:17.285455	2025-08-28 19:37:17.285455	2025-08-28 00:00:00	\N	\N	\N	f	\N	\N
cb445980-5f31-4210-8835-f620c9069cd5	d15ecbd7-4f65-472e-9d8d-b12cd3797ec0	e8684c18-858f-4271-a1c6-9d622b77c471	2025-08-28 00:00:00	2026-08-28 00:00:00	20000.00	20000.00	active	\N	2025-08-28 19:37:32.27546	2025-08-28 19:37:32.27546	2025-08-28 00:00:00	\N	\N	\N	f	\N	\N
424d357c-ba6f-4312-8527-52973cf0d804	d15ecbd7-4f65-472e-9d8d-b12cd3797ec0	aca97846-a7d3-413d-ad79-05336a6cf855	2025-08-28 00:00:00	2026-08-28 00:00:00	20000.00	20000.00	active	\N	2025-08-28 19:37:36.114942	2025-08-28 19:37:36.114942	2025-08-28 00:00:00	\N	\N	\N	f	\N	\N
749892d8-bafa-45e4-8f27-66708a5abbea	a9190f9f-e49a-423e-b798-ee5fba88cadf	007468de-0ba0-4014-953a-0b0e2ebe091e	2025-08-28 00:00:00	2026-08-28 00:00:00	20000.00	20000.00	active	\N	2025-08-28 20:06:01.769673	2025-08-28 20:06:01.769673	2025-08-28 00:00:00	\N	\N	\N	f	\N	\N
c42b0660-d6dd-4d4d-9597-ad2d32f629aa	e2fa4f9c-3b1e-4cdf-bfec-980154078802	3c462235-e652-463f-a89a-ffcf6693569a	2025-08-28 00:00:00	2026-08-28 00:00:00	20000.00	20000.00	active	\N	2025-08-28 20:06:20.306992	2025-08-28 20:06:20.306992	2025-08-28 00:00:00	\N	\N	\N	f	\N	\N
0a53ce7c-9379-4f07-9d58-7766bf7a4485	810e3926-0639-4d4c-a8d6-99bf82198876	d593f8db-085b-4830-9f4a-498c3b5ede78	2025-08-28 00:00:00	2026-08-28 00:00:00	20000.00	20000.00	active	\N	2025-08-28 20:08:12.42081	2025-08-28 20:08:12.42081	2025-08-28 00:00:00	\N	\N	\N	f	\N	\N
\.
...
COPY public.payments (id, tenant_id, lease_id, unit_id, amount, payment_date, due_date, payment_method, status, description, transaction_id, notes, created_at, updated_at, mpesa_phone_number, mpesa_checkout_request_id, mpesa_transaction_id, mpesa_receipt_number, tx_id, invoice_id) FROM stdin;
d69a3e30-989c-4efb-86c4-7b49e8717bf7	524633e8-667b-4a00-9346-25c7fe8e3e54	\N	27d38268-1b36-4e79-9520-b3b4a4a5730b	65000.00	2025-01-15 00:00:00	2025-01-15 00:00:00	mpesa	paid	January 2025 rent payment	\N	\N	2025-08-28 15:03:29.837184	2025-08-28 15:03:29.837184	\N	\N	\N	\N	\N	\N
977bc3da-27ec-4dc6-a0b5-73cdddeca730	9975884a-6ff5-4bdd-b05d-822b00dac43d	\N	957fb6d3-d620-4d2e-bf86-5e20bf169990	85000.00	2025-01-10 00:00:00	2025-01-15 00:00:00	mpesa	paid	January 2025 rent payment	\N	\N	2025-08-28 15:03:29.837184	2025-08-28 15:03:29.837184	\N	\N	\N	\N	\N	\N
fcd4924f-42e4-49b4-b862-6093795c6809	8c6c5d2a-c1c8-4cd6-a973-2e6b2f2e6246	\N	6b63d494-d6b3-4c60-ba59-8d8dd43a0205	60000.00	2025-01-10 00:00:00	2025-01-15 00:00:00	bank_transfer	paid	January 2025 partial rent payment (60K of 120K)	\N	\N	2025-08-28 15:03:29.837184	2025-08-28 15:03:29.837184	\N	\N	\N	\N	\N	\N
b24296ec-ec6b-4a59-9f0b-7a04701c4a36	524633e8-667b-4a00-9346-25c7fe8e3e54	\N	27d38268-1b36-4e79-9520-b3b4a4a5730b	65000.00	2025-02-15 00:00:00	2025-02-15 00:00:00	mpesa	pending	February 2025 rent payment	\N	\N	2025-08-28 15:03:29.837184	2025-08-28 15:03:29.837184	\N	\N	\N	\N	\N	\N
7906083d-0784-4009-ba2f-d48701ea7274	8c6c5d2a-c1c8-4cd6-a973-2e6b2f2e6246	\N	6b63d494-d6b3-4c60-ba59-8d8dd43a0205	60000.00	2025-02-15 00:00:00	2025-02-15 00:00:00	mpesa	pending	February 2025 remaining balance (60K of 120K)	\N	\N	2025-08-28 15:03:29.837184	2025-08-28 15:03:29.837184	\N	\N	\N	\N	\N	\N
43d8570f-056a-4fbc-80b1-84ab2db6e61b	9975884a-6ff5-4bdd-b05d-822b00dac43d	\N	957fb6d3-d620-4d2e-bf86-5e20bf169990	85000.00	2024-12-15 00:00:00	2024-12-15 00:00:00	mpesa	overdue	December 2024 rent payment	\N	\N	2025-08-28 15:03:29.837184	2025-08-28 15:03:29.837184	\N	\N	\N	\N	\N	\N
\.
...
a81805ea-efb4-423e-9108-751681104c5d	TURUKANA APTS	apartment_complex	123 Test St	Nairobi	Nairobi	\N	\N	5	active	\N	\N	\N	\N	2025-08-27 15:29:57.695442	2025-08-28 16:27:46.416	\N	\N	\N	\N	\N	\N	\N	\N	\N	7.50	\N	\N	f	\N	\N
f9b2e119-da66-40f4-a2d4-ea27a5dbad89	KOITALEL	apartment_complex	123 Test St	Nairobi	Nairobi	\N	\N	5	active	\N	\N	\N	\N	2025-08-27 19:54:44.814203	2025-08-28 16:28:03.928	\N	\N	\N	\N	\N	\N	\N	\N	\N	7.50	\N	\N	f	\N	\N
f36eb3c0-af11-4bd7-9adb-2de29135d5e5	QA Test Property UPDATED	apartment_complex	123 Test Street	Nairobi	Nairobi	\N	\N	5	active	\N	\N	\N	\N	2025-08-28 17:22:23.80653	2025-08-28 17:22:37.326	\N	\N	\N	\N	\N	\N	\N	\N	\N	7.50	\N	\N	f	\N	\N
\.


--
-- Data for Name: property_recurring_fees; Type: TABLE DATA; Schema: public; Owner: -
--
...
klj7OiWYvqQUHthk6QkQgxsGYYqURnK8	{"cookie": {"path": "/", "secure": false, "expires": "2025-09-04T17:42:31.329Z", "httpOnly": true, "originalMaxAge": 604800000}, "userId": "81fbbaab-2b80-45d0-bf53-ad6be7e7905f"}	2025-09-04 20:21:14
...
--
-- Data for Name: tenant_deposits; Type: TABLE DATA; Schema: public; Owner: -
--
...
--
-- Data for Name: tenant_documents; Type: TABLE DATA; Schema: public; Owner: -
--
...
--
-- Data for Name: tenant_gadgets; Type: TABLE DATA; Schema: public; Owner: -
--
...
--
-- Data for Name: unit_recurring_fees; Type: TABLE DATA; Schema: public; Owner: -
--
...
579511fd-d630-4279-98aa-633a3223eec7	e6248e10-7d91-4f2c-8202-a3516c554478	EP14	2	1.0	650	35000.00	35000.00	occupied	Two bedroom with modern kitchen and backup power	2025-08-27 15:51:13.893333	2025-08-27 15:51:13.893333	\N	\N	f	\N	\N
41617cbe-0e5d-4341-a2b0-c03f977c14a2	e6248e10-7d91-4f2c-8202-a3516c554478	EP17	2	1.0	650	35000.00	35000.00	occupied	Two bedroom with modern kitchen and backup power	2025-08-27 15:51:13.893333	2025-08-27 15:51:13.893333	\N	\N	f	\N	\N
e4945474-4df8-46e6-a377-08391ba7b16a	e6248e10-7d91-4f2c-8202-a3516c554478	EP20	2	1.0	650	35000.00	35000.00	occupied	Two bedroom with modern kitchen and backup power	2025-08-27 15:51:13.893333	2025-08-27 15:51:13.893333	\N	\N	f	\N	\N
d15ecbd7-4f65-472e-9d8d-b12cd3797ec0	e6248e10-7d91-4f2c-8202-a3516c554478	EP19	1	1.0	480	25000.00	25000.00	occupied	One bedroom apartment near town center with parking	2025-08-27 15:51:13.893333	2025-08-27 15:51:13.893333	\N	\N	f	\N	\N
a9190f9f-e49a-423e-b798-ee5fba88cadf	e6248e10-7d91-4f2c-8202-a3516c554478	EP16	1	1.0	480	25000.00	25000.00	occupied	One bedroom apartment near town center with parking	2025-08-27 15:51:13.893333	2025-08-27 15:51:13.893333	\N	\N	f	\N	\N
e2fa4f9c-3b1e-4cdf-bfec-980154078802	e6248e10-7d91-4f2c-8202-a3516c554478	EP2	2	1.0	650	35000.00	35000.00	occupied	Two bedroom with modern kitchen and backup power	2025-08-27 15:51:13.893333	2025-08-27 15:51:13.893333	\N	\N	f	\N	\N
810e3926-0639-4d4c-a8d6-99bf82198876	e6248e10-7d91-4f2c-8202-a3516c554478	EP23	2	1.0	650	35000.00	35000.00	occupied	Two bedroom with modern kitchen and backup power	2025-08-27 15:51:13.893333	2025-08-27 15:51:13.893333	\N	\N	f	\N	\N
...
b842cc5e-809c-4db2-b955-3c9542ca82c1	f36eb3c0-af11-4bd7-9adb-2de29135d5e5	QA-101-UPDATED	2	1.0	\N	25000.00	\N	vacant	\N	2025-08-28 17:30:27.821408	2025-08-28 17:30:27.821408	\N	\N	f	\N	\N
3581ef01-5960-4ac4-9771-c27b093f1365	f36eb3c0-af11-4bd7-9adb-2de29135d5e5	QA-101-UPDATED	2	1.0	\N	30000.00	\N	occupied	\N	2025-08-28 17:23:37.196642	2025-08-28 17:30:56.846	\N	\N	f	\N	\N
\.


--
-- Data for Name: user_access_requests; Type: TABLE DATA; Schema: public; Owner: -
--
...
3c462235-e652-463f-a89a-ffcf6693569a	agnes.mbatha@gmail.com	Agnes	Mbatha	tenant	+254790123478	t	2025-08-27 15:52:20.318571	2025-08-28 20:06:20.363	\N	\N	\N	t	\N	\N	\N	\N	\N	\N	\N	f	\N	\N
...
e32c34d0-86c6-47f9-950d-9b31f87a4aef	qa.tester@test.com	QA	Tester	tenant	\N	t	2025-08-28 17:24:11.018047	2025-08-28 17:24:11.154	\N	\N	\N	t	\N	\N	\N	\N	\N	\N	\N	f	\N	\N
60345685-88fb-4b28-8bdf-4a26314b80c6	qa.tenant.fixed@test.com	QA	Tenant	tenant	0700123456	t	2025-08-28 17:30:56.70168	2025-08-28 17:30:56.808	\N	\N	\N	t	\N	\N	\N	\N	\N	\N	\N	f	\N	\N
524633e8-667b-4a00-9346-25c7fe8e3e54	john.doe@example.com	John	Doe	tenant	555-123-4567	t	2025-08-27 14:46:16.369373	2025-08-28 17:53:02.583	\N	\N	\N	t	\N	\N	\N	\N	\N	\N	\N	f	\N	\N
a35934b4-b108-4be9-894a-967c257a8da9	ad@gmail.com	Sharlune	ahine	tenant	0702198791	t	2025-08-28 15:39:28.243302	2025-08-28 17:53:21.643	\N	\N	\N	t	\N	\N	\N	\N	\N	\N	\N	f	\N	\N
9975884a-6ff5-4bdd-b05d-822b00dac43d	superadmin@school.com	Kwame	Alex	tenant	0867768723943	t	2025-08-27 15:02:44.380938	2025-08-28 17:53:50.726	\N	\N	\N	t	\N	\N	\N	\N	\N	\N	\N	f	\N	\N
8c6c5d2a-c1c8-4cd6-a973-2e6b2f2e6246	test@example.com	Test	User	tenant	123456789	t	2025-08-27 15:15:51.187544	2025-08-28 18:04:00.532	\N	\N	\N	t	\N	\N	\N	\N	\N	\N	\N	f	\N	\N
11ca1000-416a-4fe9-8561-f6bf6b204d90	test2@example.com	Test	User	tenant	123456789	t	2025-08-27 15:30:12.168795	2025-08-28 19:35:38.943	\N	\N	\N	t	\N	\N	\N	\N	\N	\N	\N	f	\N	\N
e5936f37-2444-47c2-a6e0-0d91653f4778	test3@example.com	Test	User	tenant	123456789	t	2025-08-27 15:30:43.14318	2025-08-28 19:37:11.67	\N	\N	\N	t	\N	\N	\N	\N	\N	\N	\N	f	\N	\N
e8684c18-858f-4271-a1c6-9d622b77c471	peter.mungai@yahoo.com	Peter	Mungai	tenant	+254723456789	t	2025-08-27 15:52:20.318571	2025-08-28 19:37:32.339	\N	\N	\N	t	\N	\N	\N	\N	\N	\N	\N	f	\N	\N
aca97846-a7d3-413d-ad79-05336a6cf855	admin@school.co.ke	Kwame	Achieng	tenant	2345675	t	2025-08-27 15:26:29.406902	2025-08-28 19:37:36.171	\N	\N	\N	t	\N	\N	\N	\N	\N	\N	\N	f	\N	\N
007468de-0ba0-4014-953a-0b0e2ebe091e	geltechke@gmail.com	Agini	Andisi	tenant	\N	t	2025-08-27 15:01:19.738891	2025-08-28 20:06:01.83	44061691	\N	\N	t	\N	\N	\N	\N	\N	\N	\N	f	\N	\N
81062927-0c65-48d2-9a57-b8c15e98c12c	clerk@school.com	Pope	asiko	tenant	0702198791	t	2025-08-28 20:07:25.773927	2025-08-28 20:07:25.773927	\N	\N	\N	f	\N	\N	\N	\N	\N	\N	\N	f	\N	\N
d593f8db-085b-4830-9f4a-498c3b5ede78	hiyuo@hmcoo.com	Pope	John	tenant	\N	t	2025-08-28 12:33:15.791029	2025-08-28 20:08:12.484	\N	\N	\N	t	\N	\N	\N	\N	\N	\N	\N	f	\N	\N
\.
...
SELECT pg_catalog.setval('public.audit_logs_id_seq', 129, true);
...
--
-- Name: property_recurring_fees property_recurring_fees_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: tenant_deposits tenant_deposits_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: tenant_gadgets tenant_gadgets_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: unit_recurring_fees unit_recurring_fees_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: users users_replit_id_key; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: idx_invoices_tenant_period; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_invoices_tenant_period ON public.invoices USING btree (tenant_id, period_year, period_month);


--
-- Name: idx_invoices_unpaid; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_invoices_unpaid ON public.invoices USING btree (status, due_date);


--
-- Name: idx_leases_occupancy_report; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_payments_monthly_reports; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_payments_revenue_analytics; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_properties_fulltext; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_units_available; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_units_with_rent; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_users_fulltext; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_users_tenant_lookup; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: leases leases_audit_trigger; Type: TRIGGER; Schema: public; Owner: -
--
...
--
-- Name: maintenance_requests maintenance_requests_audit_trigger; Type: TRIGGER; Schema: public; Owner: -
--
...
--
-- Name: payments payments_audit_trigger; Type: TRIGGER; Schema: public; Owner: -
--
...
--
-- Name: tenant_deposits tenant_deposits_audit_trigger; Type: TRIGGER; Schema: public; Owner: -
--
...
--
-- Name: tenant_documents tenant_documents_audit_trigger; Type: TRIGGER; Schema: public; Owner: -
--
...
--
-- Name: units units_audit_trigger; Type: TRIGGER; Schema: public; Owner: -
--
...
--
-- Name: expenditures expenditures_deleted_by_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.expenditures
    ADD CONSTRAINT expenditures_deleted_by_fkey FOREIGN KEY (deleted_by) REFERENCES public.users(id);


--
-- Name: expenditures expenditures_property_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.expenditures
    ADD CONSTRAINT expenditures_property_id_fkey FOREIGN KEY (property_id) REFERENCES public.properties(id);


--
-- Name: invoices invoices_tenant_id_users_id_fk; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: invoices invoices_unit_id_units_id_fk; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: leases leases_deleted_by_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: leases leases_tenant_id_users_id_fk; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: leases leases_unit_id_units_id_fk; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: maintenance_requests maintenance_requests_assigned_to_users_id_fk; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: maintenance_requests maintenance_requests_tenant_id_users_id_fk; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: payments payments_lease_id_leases_id_fk; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: payments payments_tenant_id_users_id_fk; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: payments payments_unit_id_units_id_fk; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: properties properties_deleted_by_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: properties properties_manager_id_users_id_fk; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: property_recurring_fees property_recurring_fees_property_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: tenant_deposits tenant_deposits_lease_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: tenant_deposits tenant_deposits_tenant_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: tenant_documents tenant_documents_uploaded_by_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: tenant_gadgets tenant_gadgets_lease_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: tenant_gadgets tenant_gadgets_tenant_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: unit_recurring_fees unit_recurring_fees_unit_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: units units_deleted_by_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: user_access_requests user_access_requests_reviewed_by_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: tenant_documents documents_owner_access; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: leases leases_management_access; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: leases leases_tenant_access; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: maintenance_requests maintenance_staff_access; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: maintenance_requests maintenance_tenant_access; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: payments payments_landlord_access; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: payments payments_tenant_access; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: tenant_deposits; Type: ROW SECURITY; Schema: public; Owner: -
--
...
--
-- Name: users users_view_tenants; Type: POLICY; Schema: public; Owner: -
--
